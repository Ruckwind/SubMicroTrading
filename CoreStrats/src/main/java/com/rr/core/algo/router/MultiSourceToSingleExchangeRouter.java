...
public final class MultiSourceToSingleExchangeRouter implements OrderRouter {
    ...
    public MultiSourceToSingleExchangeRouter( String id, final EventHandler dest, RouterSharedData sharedData ) {
        super();
        _dest = dest;
     ...
     */
    @Override
    public final EventHandler getRoute( final NewOrderSingle nos, final EventHandler replyHandler ) {
    ...
    @Override
    public final EventHandler[] getAllRoutes() {
        return _all;
    }
