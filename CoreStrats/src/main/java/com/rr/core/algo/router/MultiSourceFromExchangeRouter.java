...
public final class MultiSourceFromExchangeRouter implements MessageRouter {
    ...
    private final EventHandler    _hub;
    ...
    public MultiSourceFromExchangeRouter( String id, EventHandler hub, RouterSharedData sharedData ) {
        super();
        _id = id;
        _hub = hub;
    ...
    private boolean handleExec( CommonExecRpt msg ) {
        ...
        EventHandler mh = _sharedData.findHandler( msg.getClOrdId(), msg.getOrderId() );
    ...
    private void routeInwards( Message msg, EventHandler mh ) {
