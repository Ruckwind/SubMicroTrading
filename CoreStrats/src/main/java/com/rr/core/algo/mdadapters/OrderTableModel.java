...
public class OrderTableModel extends AbstractTableModel implements EventHandler {
    ...
    static final class MiniOrderRequest implements Comparable<MiniOrderRequest> {
        ...
        MiniOrderRequest( NewOrderSingle nos ) {
            ...
            _price = Utils.zeroNull( nos.getPrice() );
            _orderQty = Utils.zeroNull( nos.getOrderQty() );
        ...
        MiniOrderRequest( CancelReplaceRequest amend ) {
            ...
            _price = Utils.zeroNull( amend.getPrice() );
            _orderQty = Utils.zeroNull( amend.getOrderQty() );
    ...
    private synchronized void updateOrderFromExec( MiniOrderRequest ord, CommonExecRpt rpt ) {
        ...
        ord._avePx = Utils.zeroNull( rpt.getAvgPx() );
        ord._cumQty = Utils.zeroNull( rpt.getCumQty() );
    }
