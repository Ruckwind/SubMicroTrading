...
public interface Strategy<T extends Book> extends SMTControllableComponent, NonBlockingWorker {
     ...
     */
    public interface ExchangeHandler<T extends Book> extends EventHandler {
    ...
    /**
     * TRY and force state to the supplied state .... based on
     * @param forcedState
     * @return previous state
     */
    public boolean setCompRunState( CompRunState forcedState );
