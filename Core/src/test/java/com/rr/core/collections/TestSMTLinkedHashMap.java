...
public class TestSMTLinkedHashMap extends BaseTestCase {

    private int _counter = 0;

    @Test public void clearRecycle() {
        SMTLinkedHashMap<ReusableString, ReusableString> map = new SMTLinkedHashMap<>( 2 );
    ...
    public void mapGrowth() {
        SMTLinkedHashMap<ZString, String> map = new SMTLinkedHashMap<>( 2 );
        ...
        map.entrySet().forEach( ( n ) -> {
            ReusableString expKey = new ReusableString( "kkkkkkkk" + _counter );
            String         expVal = "aaa" + _counter;

            ZString key = n.getKey();
            String  val = n.getValue();

            assertEquals( expKey, key );
            assertEquals( expVal, expVal );
    ...
    public void matchOthgerZStringKey() {
        SMTLinkedHashMap<ZString, String> map = new SMTLinkedHashMap<>( 10 );
    ...
    @Test public void orderIds() {
        ...
        SMTMap<ZString, String> m = new SMTLinkedHashMap<>( 128 );
