...
public class DebugBinaryEncodeBuilder<T extends AbstractBinaryEncoderUtils> implements BinaryEncodeBuilder {
    ...
    @Override public void encodeBase36Number( final long value, final int len ) {
        startTrace( "stringFixedWidth" );
        _builder.encodeBase36Number( value, len );
        _dump.append( value );
        endTrace();
    }
    ...
    @Override public void encodeTimestampLocal( final long internalTime ) {
        startTrace( "timestampLocal" );
        _builder.encodeTimestampLocal( internalTime );
        _dump.append( internalTime );
        endTrace();
    }
    ...
    public void encodeTimestampUTC( long internalTime ) {
        ...
        _builder.encodeTimestampUTC( internalTime );
        _dump.append( internalTime );
        endTrace();
    }
    ...
    public void encodeTimeUTC( long internalTime ) {
        startTrace( "timeUTC" );
        _builder.encodeTimeUTC( internalTime );
        _dump.append( internalTime );
        endTrace();
    }

    @Override public void encodeTimeLocal( final long internalTime ) {
        startTrace( "timeLocal" );
        _builder.encodeTimeLocal( internalTime );
        _dump.append( internalTime );
        endTrace();
    }
