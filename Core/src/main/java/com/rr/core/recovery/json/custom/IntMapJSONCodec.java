...
public class IntMapJSONCodec implements JSONClassCodec {
    ...
    @Override public Object decode( final JSONReader reader, final ReusableString tmpStr, Class<?> postClass, int jsonId ) throws Exception {
        ...
        IntMap<Object> map = (IntMap<Object>) postClass.newInstance();
        ...
        if ( tokeniser.getToken( nxt ) != JSONInputTokeniser.Token.EndArray ) {
            ...
            do {
                ...
                if ( key != null && value != null ) {
                    reader.setFieldHandleMissingRef( value, ( resolved ) -> { if ( resolved != null ) map.put( ((Number) key).intValue(), resolved ); } );
                }
