...
public class MemMapPersister extends BaseMemMapPersister {
    ...
    private enum ReplayCode {EndOfPage, SkippedBad, LastRecord, ReplayedRec}
     ...
     */
    @Override public long persist( byte[] fromBuffer, int offset, int length ) throws PersisterException {
    ...
    @Override public long persist( byte[] fromBuffer, int offset, int length, byte[] optional, int optOffset, int optLen ) throws PersisterException {
    ...
    @Override public void replay( PersistentReplayListener listener ) throws PersisterException {
    ...
    @Override public void setLowerFlags( long key, byte flags ) throws PersisterException {
        if ( _isOpen ) {
    ...
    @Override public void setUpperFlags( long key, byte flags ) throws PersisterException {
