...
public abstract class BaseEvent<T> implements Reusable<T>, Event {

    private          T     _next;                    // used for pooling
    private volatile Event _nextMessage;             // used for concurrent Q

    private              int  _msgSeqNum      = Constants.UNSET_INT;
    private @TimestampMS long _eventTimestamp = Constants.UNSET_LONG;
    ...
    @Override public final void setMsgSeqNum( int val ) {
        _msgSeqNum = val;
    }
    ...
    @Override public final T getNext()                        { return _next; }

    @Override public final void setNext( T nxt )              { _next = nxt; }
