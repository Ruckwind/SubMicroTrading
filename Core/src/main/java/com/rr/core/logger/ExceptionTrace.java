...
public class ExceptionTrace {
    ...
    public static void getStackTrace( ReusableString trace, Throwable t ) {
        if ( t != null ) {
    ...
    public static void dumpStackTrace( ReusableString trace ) {
        ...
        for ( Thread t : stackTraceMap.keySet() ) {
            dumpStackTrace( trace, stackTraceMap, t );
        }
    }

    public static void dumpStackTrace( final ReusableString trace, final Map<Thread, StackTraceElement[]> stackTraceMap, final Thread t ) {
    ...
    public static void addStackFrame( ReusableString buf, StackTraceElement entry ) {
