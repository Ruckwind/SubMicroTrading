 ...
 */
public class WeeklyBase32IDGeneratorV2 extends AbstractBase32IDGenerator {

    public WeeklyBase32IDGeneratorV2() {
        super();
    }
     ...
     */
    public WeeklyBase32IDGeneratorV2( ZString processInstanceSeed, int len ) {
