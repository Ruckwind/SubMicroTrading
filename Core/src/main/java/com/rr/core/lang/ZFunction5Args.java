 ...
 */
@FunctionalInterface
public interface ZFunction5Args<S, T, U, V, X, R> extends SerializableLambda {

    default <W> ZFunction5Args<S, T, U, V, X, W> andThen( Function<? super R, ? extends W> after ) {
        Objects.requireNonNull( after );
        return ( S s, T t, U u, V v, X x ) -> after.apply( apply( s, t, u, v, x ) );
    }
