 ...
 * <p>
 * dont batch lastConsumed ... removed due to situations where consumers can lag producer
 */
public final class RingBufferEventQueue1C1P implements EventQueue {
    ...
    public RingBufferEventQueue1C1P( int size ) {
        this( null, size );
    }

    public RingBufferEventQueue1C1P( String id, int size ) {
    ...
    /**
     * @return
     * @WARNING non thread safe iterator ... caller responsible for appropriate locking
     */
    @Override public Iterator<Event> iterator() {
        return new Iterator<Event>() {

            private long _next = _lastConsumed + 1;
            private long _last = _lastFullyAdded;
    ...
    @Override
    public int size() {
        return (int) (_lastClaimedByProducer - _lastConsumed);
    }
    ...
    @Override public EventQueue newInstance() {
        return new RingBufferEventQueue1C1P( _id, _size );
    }
