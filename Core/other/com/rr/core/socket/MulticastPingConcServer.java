    ...
    private class Producer implements Runnable {
        ...
        public void run() {
            try {
                ...
                ThreadUtilsFactory.get().setPriority( Thread.currentThread(), ThreadPriority.HIGHEST, 128 );
    ...
    private class Consumer implements Runnable {
        ...
        public void run() {
            try {
                ...
                ThreadUtilsFactory.get().setPriority( Thread.currentThread(), ThreadPriority.HIGHEST, 256 );
