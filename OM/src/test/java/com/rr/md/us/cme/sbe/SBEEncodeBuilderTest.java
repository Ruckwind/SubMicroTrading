...
public class SBEEncodeBuilderTest extends BaseTestCase {
    ...
    public void testEncodeBase36() {
        doEncodeBase36( 1, "0000000000001" );
        doEncodeBase36( 99999, "000000000255R" );
        doEncodeBase36( 98765432101234L, "0000Z0C7O83UA" );
        doEncodeBase36( 0, "0000000000000" );
        doEncodeBase36( Long.MAX_VALUE, "1Y2P0IJ32E8E7" );
        doEncodeBase36( 1000, "00000000000RS" );
        doEncodeBase36( Constants.UNSET_LONG, "0000000000000" );
    ...
    private void doEncodeBase36( long val, String expected ) {
        _builder.start();

        _builder.encodeBase36Number( val, 13 );

        String v = new String( _buf, 0, _builder.getNextFreeIdx() );
