...
@SuppressWarnings( "UnusedAssignment" ) public class SBEDecodeBuilderTest extends BaseTestCase {
    ...
    public void testDecodeBase36() {
        doDecodeBase36( 1, "0000000000001" );
        doDecodeBase36( 99999, "000000000255R" );
        doDecodeBase36( 98765432101234L, "0000Z0C7O83UA" );
        doDecodeBase36( 0, "0000000000000" );
        doDecodeBase36( Long.MAX_VALUE, "1Y2P0IJ32E8E7" );
        doDecodeBase36( 1000, "00000000000RS" );
    }
    ...
    private void doDecodeBase36( long val, String expected ) {

        _builder.start( expected.getBytes(), 0, expected.length() );

        long decoded = _builder.decodeBase36Number( 13 );
