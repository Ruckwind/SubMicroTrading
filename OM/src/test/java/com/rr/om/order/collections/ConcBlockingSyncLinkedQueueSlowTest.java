...
import com.rr.core.collections.ConcBlockingSyncLinkedQueue;
 ...
 * @author Richard Rose
 */
public class ConcBlockingSyncLinkedQueueSlowTest extends BaseTestCase {

    private static final Logger _log = ConsoleFactory.console( ConcBlockingSyncLinkedQueueSlowTest.class, Level.WARN );
    ...
    @SuppressWarnings( "NonAtomicOperationOnVolatileField" ) private static class ConsumerRunnable implements Runnable {
        ...
        private          int                         _tot;
        private          ConcBlockingSyncLinkedQueue _q;
        private volatile boolean                     _finished = false;
        private volatile int                         _count    = 0;
        private volatile long                        _totQty   = 0;
        private          CountDownLatch              _cdl;

        public ConsumerRunnable( int tot, ConcBlockingSyncLinkedQueue q, CountDownLatch cdl ) {
            _tot = tot;
            _q   = q;
            _cdl = cdl;
        }
    ...
    public void testAdd() {
        ...
        ConcBlockingSyncLinkedQueue q = new ConcBlockingSyncLinkedQueue();
    ...
    protected void doTestThreaded( int count, int threads ) {
        ...
        synchronized( ConcBlockingSyncLinkedQueueSlowTest.class ) {
