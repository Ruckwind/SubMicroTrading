...
public class TestCancelReplaceRequest extends BaseProcessorTestCase {
    ...
    public void testAmendAfterCancelReject() {
        ...
        assertEquals( 80, client.getTotalOrderQty(), Constants.TICK_WEIGHT );
        assertEquals( 20.0 * 80, client.getTotalOrderValueUSD(), Constants.WEIGHT );
    }
    ...
    public void testAmendMsgDup() {
        ...
        assertEquals( 23.0 * 90, client.getTotalOrderValueUSD(), Constants.WEIGHT );
        ...
        _proc.handle( cdup2 );
        checkQueueSize( 1, 0, 0 );
        CancelRejectImpl crej = (CancelRejectImpl) getMessage( _upQ, CancelRejectImpl.class );
    ...
    public void testAmendRejectAsNotOpenState() {
        ...
        _proc.handle( cbad1 );
        checkQueueSize( 1, 0, 0 );
        getMessage( _upQ, CancelRejectImpl.class );
        clearQueues();
        ...
        _proc.handle( cbad2 );
        checkQueueSize( 1, 0, 0 );
        CancelRejectImpl crej2 = (CancelRejectImpl) getMessage( _upQ, CancelRejectImpl.class );
    ...
    public void testMultiAmendDownWithFills() {
        ...
        assertSame( order.getClientProfile(), nos.getClient() );
        assertEquals( 80, client.getTotalOrderQty(), Constants.TICK_WEIGHT );
        assertEquals( totTraded + (80 - cumQty) * 20.0, client.getTotalOrderValueUSD(), Constants.WEIGHT );
    }
    ...
    public void testSimpleAmend() {
        ...
        ClientCancelReplaceRequestImpl ccrr = FixTestUtils.getClientCancelReplaceRequest( _msgBuf, _decoder, _clOrdId, nos.getClOrdId(), 90, 23.0, _upMsgHandler );

        assertEquals( ccrr.getOrigClOrdId(), nos.getClOrdId() );
