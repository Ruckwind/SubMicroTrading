...
public class TestCancelRequest extends BaseProcessorTestCase {
    ...
    private void checkClientCancelled( ClientNewOrderSingleImpl cnos,
        ...
        assertEquals( cnos.getPrice(), ccxl.getPrice(), Constants.WEIGHT );
        assertEquals( 0, ccxl.getLeavesQty(), Constants.TICK_WEIGHT );
        assertEquals( 0, ccxl.getCumQty(), Constants.TICK_WEIGHT );
        assertEquals( 0.0, ccxl.getAvgPx(), Constants.WEIGHT );
