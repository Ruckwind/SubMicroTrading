...
public class TestTradeNew extends BaseProcessorTestCase {
    ...
    public void testFillInPendingAmend() {
        ...
        assertEquals( 23.0 * (90 - cumQty) + totTraded, client.getTotalOrderValueUSD(), Constants.WEIGHT );
    }
    ...
    public void testFullFillOnOpenState() {
        ...
        double lastQty = cnos.getOrderQty();
        double lastPx  = 24.0;
    ...
    public void testFullFillOnPendingCancel() {
        ...
        assertEquals( 100 * 24.0, client.getTotalOrderValueUSD(), Constants.WEIGHT );
    ...
    public void testFullFillOnPendingReplace() {
        ...
        assertSame( order.getClientProfile(), nos.getClient() );
        assertEquals( 100, client.getTotalOrderQty(), Constants.TICK_WEIGHT );
        assertEquals( totTraded, client.getTotalOrderValueUSD(), Constants.WEIGHT );
    ...
    public void testThreeFillsToFullyFilled() {
        ...
        double lastQty3 = cnos.getOrderQty() - (lastQty1 + lastQty2);
        double lastPx3  = 22.0;
