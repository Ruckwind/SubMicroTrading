...
public class ETICodecTest extends BaseTestCase {
    ...
    public void DISABLED_testImmediateExecResponse() {
        ...
        assertEquals( 219, trade.getLastQty(), Constants.TICK_WEIGHT );
        assertEquals( 219, trade.getCumQty(), Constants.TICK_WEIGHT );
        assertEquals( 0, trade.getLeavesQty(), Constants.TICK_WEIGHT );
    ...
    public void DISABLED_testPassiveFill() {
        ...
        assertTrue( ctx.getLastApplMsgID().length() == 16 );
        assertEquals( 98, trade.getLastQty(), Constants.TICK_WEIGHT );
        assertEquals( 98, trade.getCumQty(), Constants.TICK_WEIGHT );
        assertEquals( 119, trade.getLeavesQty(), Constants.TICK_WEIGHT );
    ...
    public void testACKDecodeReEncode() {
        ...
        String nos = "8=FIX.4.4; 9=151; 35=D; 43=N; 49=PROPA; 56=ME; 34=12243; 52=" + _dateStr + "-12:01:01.100; " +
                     "11=11223344; 59=0; 22=R; 48=1199; 38=10; 44=10.23; 40=2; 54=1; 55=BT.XLON; 21=1; " +
        ...
        String ack = "8=FIX.4.4; 9=177; 35=8; 43=N; 34=12243; 49=PROPA; 52=" + _dateStr + "-12:01:01.232; " +
                     "56=ME; 37=333111; 39=0; 150=0; 40=1; 54=1; 55=BT.XLON; 11=11223344; 21=1; 60=" + _dateStr + "-12:01:01; 38=10; " +
                     "59=0; 22=R; 48=1199; 1111=PR; 17=998877; 10=233; ";
    ...
    public void testNOSEncodeDecode() {
        ...
        String nos = "8=FIX.4.4; 9=172; 35=D; 43=N; 49=PROPA; 56=ME; 34=12243; 52=" + _dateStr + "-12:01:01.100; " +
                     "11=12345678; 59=0; 22=R; 48=998877; 38=50; 44=10.23; 15=GBP; 40=2; 54=1; 55=BT.XLON; 21=1; " +
