...
public class TestSimpleOrderBook extends BaseTestCase {
    ...
    public void testBuyThruLevels() {
        ...
        assertEquals( 6, trade4.getLastQty(), Constants.TICK_WEIGHT );
    ...
    @Test
    public void testCrossBuy() {
        SimpleOrderBook book = new SimpleOrderBook();

        TradeNew trade1 = book.add( null, 1, 161.82, null, Side.Buy );
        TradeNew trade2 = book.add( null, 1, 158.81, null, Side.Sell );

        assertTrue( trade1 == null );
        assertNotNull( trade2 );
        assertEquals( 1, trade2.getLastQty(), Constants.TICK_WEIGHT );
        assertEquals( Side.Sell, trade2.getSide() );
        assertEquals( OrdStatus.Filled, trade2.getOrdStatus() );
        assertEquals( 161.82, trade2.getLastPx(), Constants.TICK_WEIGHT );
    }

    @Test
    public void testCrossSell() {
        SimpleOrderBook book = new SimpleOrderBook();

        TradeNew trade1 = book.add( null, 1, 158.81, null, Side.Sell );
        TradeNew trade2 = book.add( null, 1, 161.82, null, Side.Buy );
        ...
        assertEquals( OrdStatus.Filled, trade2.getOrdStatus() );
        assertEquals( 158.81, trade2.getLastPx(), Constants.TICK_WEIGHT );
    }
    ...
    public void testDoubleFullFillSell() {
        ...
        assertTrue( trade1 == null );
        assertNotNull( trade2 );
        assertEquals( 10, trade2.getLastQty(), Constants.TICK_WEIGHT );
        assertEquals( Side.Sell, trade2.getSide() );
        assertEquals( OrdStatus.Filled, trade2.getOrdStatus() );
        ...
        assertEquals( 1, trade3.getLastQty(), Constants.TICK_WEIGHT );
    ...
    public void testSimplePartialFillBuy() {
        ...
        assertTrue( trade1 == null );
        assertNotNull( trade2 );
        assertEquals( 4, trade2.getLastQty(), Constants.TICK_WEIGHT );
