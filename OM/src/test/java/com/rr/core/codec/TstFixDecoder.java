...
@SuppressWarnings( "UnusedAssignment" ) public class TstFixDecoder extends AbstractFixDecoder {
...
//    private final PoolFactory<ClientNewOrderSingleImpl>_newOrderSingleFactory = _clientNOSPool.getPoolFactory();
    ...
    @Override public FixDecoder newInstance() {
        return new TstFixDecoder( _majorVersion, _minorVersion );
    }
        ...
        while( tag != 0 ) {
            ...
            default: //  SKIP
                ...
                case 207: // securityExchange
                    start = _idx;
                    valLen = getValLength();
                    msg.setSecurityExchange( ExchangeCode.getVal( _tmpLookupKey.copy( _fixMsg, start, valLen ) ) );
                    break;
                case 528:
