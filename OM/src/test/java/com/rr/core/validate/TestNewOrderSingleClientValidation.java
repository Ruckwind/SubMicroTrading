...
public class TestNewOrderSingleClientValidation extends BaseProcessorTestCase {
    ...
    public void testAllThresholdWarnings() {
        ...
        alertMsg = "Maximum total order value exceeded , clOrdId=TST0000001, val=10012.0, max=10000.0";
    ...
    public void testQtyRejects() {
        ...
        alertMsg = "Maximum single order value exceeded , clOrdId=TST0000001, val=10100.0, max=1000.0";
        ...
        alertMsg = "Maximum single order quantity exceeded , clOrdId=TST0000001, val=388.0, max=100.0";
        ...
        alertMsg = "Maximum single order quantity exceeded , clOrdId=TST0000001, val=101.0, max=100.0";
