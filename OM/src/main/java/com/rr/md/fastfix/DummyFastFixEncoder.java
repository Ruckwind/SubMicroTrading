...
public class DummyFastFixEncoder implements FastFixEncoder {
    ...
    @Override public void encode( Event msg )       { /* nothing */ }
    ...
    @Override public Event unableToSend( Event msg, ZString errMsg ) {
        return null;
    }
    ...
    @Override public void setDebug( boolean debug ) { /* nothing */ }

    @Override public void logStats()                                              { /* nothing */ }

    @Override public void logLastMsg()                                            { /* nothing */ }
}
