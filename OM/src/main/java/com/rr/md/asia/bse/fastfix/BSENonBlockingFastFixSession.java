...
public final class BSENonBlockingFastFixSession extends NonBlockingFastFixSocketSession implements MktDataChannel<Integer> {
    ...
    public final void processNextInbound() throws Exception {
        ...
        if ( _bseScopedDecoder.decodeStartPacket( _inBuffer, offset, maxOffset ) ) {
            ...
            Event msg = _bseScopedDecoder.decode( _inBuffer, offset, maxOffset );
