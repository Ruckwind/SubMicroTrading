...
public class CMEFastFixSampleReader {
    ...
    public static void main( String args[] ) {
        ...
        LoggerFactory.initLogging( "./logs/CMEFastFixSampleReader.log", 1000000000, Level.info, 131072 );
...
//            };
        ...
        List<ZString[]> addrs = new ArrayList<>();
    ...
    private class Consumer implements Runnable {
        ...
        void consume( int max ) throws Exception {
            ...
            while( _packets < max ) {
                ...
                if ( _startMS == 0 ) _startMS = ClockFactory.get().currentTimeMillis();
                ...
                try {
                    Event dec = _decoder.decode( _inBytes, 0, numBytes );
            ...
            _endMS       = ClockFactory.get().currentTimeMillis();
