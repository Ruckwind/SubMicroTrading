...
public class CMEFastFixSoftSampleClient {
    ...
    public static void main( String args[] ) {
        ...
        LoggerFactory.initLogging( "./logs/CMEFastFixSampleClient.log", 100000000, Level.info, 131072 );
    ...
    private class Consumer implements Runnable {
        ...
        public void run() {
            try {
                ...
                ShutdownManager.instance().register( "CMELogStats" + _id, this::logStats, ShutdownManager.Priority.Medium );
        ...
        void consume( int max ) throws Exception {
            ...
            endMS       = ClockFactory.get().currentTimeMillis();
