...
public class BSESessionLoader extends BaseSessionLoader {
    ...
    public SMTComponent create( String id ) {
        ...
        try {
            ...
            ETIBSEDecoder decoder     = (ETIBSEDecoder) getFullDecoder( _codecId, _clientProfile, _trace );
            ETIBSEDecoder fullDecoder = (ETIBSEDecoder) getFullDecoder( _codecId, _clientProfile, false );

            ETISocketSession sess;

            sess = createETISession( _codecId, sessName, encoder, decoder, fullDecoder );
    ...
    protected ETISocketSession createETISession( CodecId codecId,
        ...
        Decoder        recDecoder     = getFullDecoder( codecId, _clientProfile, _trace );
        ...
        EventRouter recInboundRouter = new PassThruRouter( "passThru", getRecoveryEventHandler( sessName ) );
