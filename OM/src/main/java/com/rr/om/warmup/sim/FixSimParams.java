...
public class FixSimParams {
    ...
    private static final Logger _log = ConsoleFactory.console( FixSimParams.class, Level.info );
    ...
    private String _cpuMasksFile = ThreadUtilsFactory.get().DEFAULT_THREAD_CONFIG;
    ...
    public FixSimParams( String appName, boolean hasUpstream, boolean hasDownstream, String genIdPrerfix ) {
        ...
        _warmupPortOffset = PortOffset.getNext();
