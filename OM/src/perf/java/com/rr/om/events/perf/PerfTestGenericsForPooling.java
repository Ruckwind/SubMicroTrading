...
public class PerfTestGenericsForPooling extends BaseTestCase {
    ...
    public interface ReusableTypeInt extends Reusable<ReusableTypeInt> {
        //
    }
    public interface ReusableBase {

        ReusableBase getNext();

        void setNext( ReusableBase nxt );
    ...
    private long gen( int iterations, int batch ) {
        ...
        DummyGenericPool<ReusableGeneric> pool = new DummyGenericPool<>( r1 );
        ReusableGeneric                   r3   = null;
    ...
    private long genArray( int iterations, int batch ) {
        ...
        DummyArrayGenericPool<ReusableGeneric> pool = new DummyArrayGenericPool<>( arr );
        ReusableGeneric                        r3   = null;
