...
public class PerfCMEFastFix {
    ...
    static final         Logger    _log     = ConsoleFactory.console( PerfCMEFastFix.class );
    ...
    public static void main( String[] args ) {
        ...
        ThreadUtilsFactory.get().init( _params.getCpuMasksFile(), true );
        ...
        try {
            ...
            loader.loadFromFile( "./data/cme/secdef.t1.dat" );
    ...
    private void presize() {
        ...
        BaseFixSimProcess.presize( NewOrderSingleImpl.class, recycledEventChains, chainSize, extraAlloc );
