...
public class ETIDecoderGenerator extends BaseBinaryDecoderGenerator {

    public ETIDecoderGenerator() {
        super();
    ...
    protected String getBuilder() {
        return "com.rr.codec.emea.exchange.eti.ETIDecodeBuilderImpl";
    }
    ...
    protected String getInterfaceToImplement() {
        return "com.rr.codec.emea.exchange.eti.ETIDecoder";
    }
