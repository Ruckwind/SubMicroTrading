...
public class FastFixUtils {
    ...
    public static final byte LONG_MSB_MASK = (byte) 0x01; // the 10th byte of a LONG only has 1 bit of lva
    public static final byte INT_MSB_MASK  = (byte) 0x0F; // the 5th byte of an INT only has 4 bits of lva
