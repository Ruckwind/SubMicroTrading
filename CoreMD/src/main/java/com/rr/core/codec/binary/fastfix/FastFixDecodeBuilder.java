...
public final class FastFixDecodeBuilder implements BinaryDecodeBuilder {
    ...
    @Override public long decodeBase36Number( final int len )                             { throw new RuntimeDecodingException( "FastFixDecoder.decodeBase36Number not supported by this decoder" ); }
    ...
    @Override public double decodePrice( final int wholeDigits, final int decimalPlaces ) { throw new RuntimeDecodingException( "FastFixDecoder.decodePrice(a,b) not supported by this decoder" ); }

    @Override public int decodeQty()                                                      { throw new RuntimeDecodingException( "FastFixDecoder.decodeQty not supported by this decoder" ); }

    @Override public int decodeQty( final int len )                                       { throw new RuntimeDecodingException( "FastFixDecoder.decodeQty(len) not supported by this decoder" ); }
    ...
    @Override public long decodeTimeLocal()                                               { throw new RuntimeDecodingException( "FastFixDecoder.decodeTimeLocal not supported by this decoder" ); }

    @Override public long decodeTimeUTC()                                                 { throw new RuntimeDecodingException( "FastFixDecoder.decodeTimeUTC not supported by this decoder" ); }

    @Override public long decodeTimestampLocal()                                          { throw new RuntimeDecodingException( "FastFixDecoder.decodeTimestampLocal not supported by this decoder" ); }

    @Override public long decodeTimestampUTC()                                            { throw new RuntimeDecodingException( "FastFixDecoder.decodeTimestampUTC not supported by this decoder" ); }
