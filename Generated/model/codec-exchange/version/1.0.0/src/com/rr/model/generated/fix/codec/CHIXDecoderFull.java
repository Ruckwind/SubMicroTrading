...
public final class CHIXDecoderFull extends AbstractFixDecoder42 {
   ...
   // Constructors
    public CHIXDecoderFull( String id ) {
        this( id, FixVersion.Fix4_2._major, FixVersion.Fix4_2._minor );
    }

    public CHIXDecoderFull() {
        this( null, FixVersion.Fix4_2._major, FixVersion.Fix4_2._minor );
    }

    public CHIXDecoderFull( byte major, byte minor ) {
        this( null, major, minor );
    }
    public CHIXDecoderFull( String id, byte major, byte minor ) {
        super( major, minor );
        _id = id;
    }

    @Override public FixDecoder newInstance() {
        CHIXDecoderFull dec = new CHIXDecoderFull( getComponentId(), _majorVersion, _minorVersion );
