...
public final class MDBSEDecoder extends AbstractFixDecoderMD50 {
   ...
   // Constructors
    ...
    public MDBSEDecoder( String id, byte major, byte minor ) {
        super( major, minor );
        _id = id;
    }

    @Override public FixDecoder newInstance() {
        MDBSEDecoder dec = new MDBSEDecoder( getComponentId(), _majorVersion, _minorVersion );
    ...
    public final Event decodeHeartbeat() {
        ...
        while( _tag != 0 ) {
            ...
            case FixDictionaryMD50.SendingTime:         // tag52
                msg.setEventTimestamp( getInternalTimeFromBSEFastFix() );
                break;
    ...
    public final Event decodeTradingSessionStatus() {
        ...
        while( _tag != 0 ) {
            ...
            case FixDictionaryMD50.TransactTime:         // tag60
                msg.setTransactTime( getInternalTimeFromBSEFastFix() );
                break;
 ...
 */
    ...
    private long getInternalTimeFromBSEFastFix() {
        long msSinceEpoch = getLongVal() / 1000000; // nanos to ms
        
        return CommonTimeUtils.unixTimeToInternalTime( msSinceEpoch );
    }
}
