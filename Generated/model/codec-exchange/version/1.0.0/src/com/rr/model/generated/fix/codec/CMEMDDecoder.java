...
public final class CMEMDDecoder extends AbstractFixDecoderMD44 {
   ...
   // Constructors
    public CMEMDDecoder( String id ) {
        this( id, FixVersion.MDFix4_4._major, FixVersion.MDFix4_4._minor );
    }

    public CMEMDDecoder() {
        this( null, FixVersion.MDFix4_4._major, FixVersion.MDFix4_4._minor );
    }

    public CMEMDDecoder( byte major, byte minor ) {
        this( null, major, minor );
    }
    public CMEMDDecoder( String id, byte major, byte minor ) {
        super( major, minor );
        _id = id;
    }

    @Override public FixDecoder newInstance() {
        CMEMDDecoder dec = new CMEMDDecoder( getComponentId(), _majorVersion, _minorVersion );
    ...
    public final Event decodeSecurityDefinition() {
        ...
        while( _tag != 0 ) {
            ...
            case FixDictionaryMD44.displayFactor:         // tag9787
                ...
                break;
            case FixDictionaryMD44.securityLongDesc:         // tag9800
                start = _idx;
                valLen = getValLength();
                msg.setSecurityLongDesc( _fixMsg, start, valLen );
                break;
            case FixDictionaryMD44.underlyingSecurityIDSource:         // tag9801
                msg.setUnderlyingSecurityIDSource( SecurityIDSource.getVal( _fixMsg[_idx++] ) );
                break;
            case FixDictionaryMD44.underlyingSecurityID:         // tag9802
                start = _idx;
                valLen = getValLength();
                msg.setUnderlyingSecurityID( _fixMsg, start, valLen );
                break;
            case FixDictionaryMD44.underlyingScurityExchange:         // tag9803
                start = _idx;
                valLen = getValLength();
                _tmpLookupKey.setValue( _fixMsg, start, valLen );
                msg.setUnderlyingScurityExchange( ExchangeCode.getVal( _tmpLookupKey ) );
                break;
            case FixDictionaryMD44.primarySecurityExchange:         // tag9804
                start = _idx;
                valLen = getValLength();
                _tmpLookupKey.setValue( _fixMsg, start, valLen );
                msg.setPrimarySecurityExchange( ExchangeCode.getVal( _tmpLookupKey ) );
                break;
            case FixDictionaryMD44.commonSecurityId:         // tag9805
                msg.setCommonSecurityId( getLongVal() );
                break;
            case FixDictionaryMD44.parentCompanyId:         // tag9806
                msg.setParentCompanyId( getLongVal() );
                break;
            case FixDictionaryMD44.companyName:         // tag9811
                start = _idx;
                valLen = getValLength();
                msg.setCompanyName( _fixMsg, start, valLen );
                break;
            case FixDictionaryMD44.gicsCode:         // tag9812
                msg.setGicsCode( getLongVal() );
                break;
            case FixDictionaryMD44.getOutDate:         // tag9813
                msg.setGetOutDate( getInternalTime() );
                break;
            case FixDictionaryMD44.uniqueInstId:         // tag9814
                msg.setUniqueInstId( getLongVal() );
                break;
            case FixDictionaryMD44.deadTimestamp:         // tag9815
                msg.setDeadTimestamp( getInternalTime() );
                break;
            case FixDictionaryMD44.endTimestamp:         // tag9816
                msg.setEndTimestamp( getInternalTime() );
                break;
            case FixDictionaryMD44.startTimestamp:         // tag9817
                msg.setStartTimestamp( getInternalTime() );
                break;
            case FixDictionaryMD44.dataSrc:         // tag9818
                start = _idx;
                valLen = getValLength();
                _tmpLookupKey.setValue( _fixMsg, start, valLen );
                msg.setDataSrc( DataSrc.getVal( _tmpLookupKey ) );
                break;
            case FixDictionaryMD44.SecDefSpecialType:         // tag9819
                msg.setSecDefSpecialType( SecDefSpecialType.getVal( _fixMsg[_idx++] ) );
                break;
            case FixDictionaryMD44.CompanyStatusType:         // tag9820
                start = _idx;
                valLen = getValLength();
                _tmpLookupKey.setValue( _fixMsg, start, valLen );
            ...
            default:
                ...
                case FixDictionaryMD44.minPriceIncrementAmount:         // tag1146
                    ...
                    break;
                case FixDictionaryMD44.unitOfMeasureQty:         // tag1147
                ...
                case FixDictionaryMD44.applID:         // tag1180
                    ...
                    break;
                case FixDictionaryMD44.pricePrecision:         // tag1200
                ...
                default:
                    ...
                    default:
                        ...
                        case FixDictionaryMD44.securityDesc:         // tag107
                            ...
                            break;
                        case FixDictionaryMD44.minQty:         // tag110
                        ...
                        case FixDictionaryMD44.SecurityUpdateAction:         // tag980
                            ...
                            break;
                        case FixDictionaryMD44.unitOfMeasure:         // tag996
                            start = _idx;
                            valLen = getValLength();
                            _tmpLookupKey.setValue( _fixMsg, start, valLen );
                        ...
                        case FixDictionaryMD44.contractMultiplierType:         // tag1435
                            ...
                            break;
                        case FixDictionaryMD44.futPointValue:         // tag1700
                        ...
                        case FixDictionaryMD44.tradingReferenceDate:         // tag5796
                            ...
                            break;
                        case FixDictionaryMD44.TickRule:         // tag6350
        ...
        msg.getSymbolForUpdate().copy( msg.getSecurityDesc() );;
        return msg;
    }
    ...
    public final Event decodeMDIncRefresh() {
        ...
        while( _tag != 0 ) {
            ...
            case FixDictionaryMD44.SenderCompID:         // tag49
                ...
                break;
            case FixDictionaryMD44.SendingTime:         // tag52
                msg.setEventTimestamp( getCMETime() );;
                break;
            case FixDictionaryMD44.TargetCompID:         // tag56
                getValLength();
                break;
   ...
   // SubGrps
    ...
    private void processSDFeedTypes( SecurityDefinitionImpl parent, int numEntries ) {
       ...
       while( _tag != 0 ) {
           ...
           case FixDictionaryMD44.marketDepth:         // tag264
               msg.setMarketDepth( getIntVal() );
               break;
           case FixDictionaryMD44.feedType:         // tag1022
    ...
    private void processSecDefLegs( SecurityDefinitionImpl parent, int numEntries ) {
       ...
       while( _tag != 0 ) {
           switch( _tag ) {
           case FixDictionaryMD44.LegPrice:         // tag566
               getValLength(); // no model attribute, SKIP
               break;
           case FixDictionaryMD44.legSymbol:         // tag600
               ...
               break;
           case FixDictionaryMD44.legSecurityID:         // tag602
               start = _idx;
               valLen = getValLength();
               msg.setLegSecurityID( _fixMsg, start, valLen );
               break;
           case FixDictionaryMD44.legSecurityIDSource:         // tag603
               msg.setLegSecurityIDSource( SecurityIDSource.getVal( _fixMsg[_idx++] ) );
               break;
           case FixDictionaryMD44.legSecurityDesc:         // tag620
               start = _idx;
               valLen = getValLength();
               msg.setLegSecurityDesc( _fixMsg, start, valLen );
               break;
           case FixDictionaryMD44.legRatioQty:         // tag623
               msg.setLegRatioQty( getIntVal() );
               break;
           case FixDictionaryMD44.legSide:         // tag624
    ...
    private void processSecDefEvents( SecurityDefinitionImpl parent, int numEntries ) {
       ...
       while( _tag != 0 ) {
           switch( _tag ) {
           case FixDictionaryMD44.eventType:         // tag865
               ...
               break;
           case FixDictionaryMD44.eventDate:         // tag866
               msg.setEventDate( getLongVal() );
               break;
           case FixDictionaryMD44.eventTime:         // tag1145
    ...
    private void processMDEntrys( MDIncRefreshImpl parent, int numEntries ) {
       ...
       while( _tag != 0 ) {
           ...
           case FixDictionaryMD44.numberOfOrders:         // tag346
               ...
               break;
           case FixDictionaryMD44.netChangePrevDay:         // tag451
               getValLength(); // no model attribute, SKIP
               break;
           ...
           default:
               ...
               case FixDictionaryMD44.mdPriceLevel:         // tag1023
                   ...
                   break;
               case FixDictionaryMD44.aggressorSide:         // tag5797
                   getValLength(); // no model attribute, SKIP
                   break;
               case FixDictionaryMD44.MatchEventIndicator:         // tag5799
                   getValLength(); // no model attribute, SKIP
                   break;
               default:
                   return;
...
/*
 * CME HANDCODED DECODER METHDOS
 */

    private long getCMETime() {
