...
public final class CMEEncoder implements FixEncoder {
   ...
   // Constructors
    public CMEEncoder( String id, byte[] buf, int offset ) {
    ...
    public CMEEncoder( String id, byte major, byte minor, byte[] buf, int offset ) {
    ...
    public CMEEncoder( String id, byte major, byte minor, byte[] buf ) {
   ...
   // encode methods
    ...
    @Override public FixEncoder newInstance() {
        ...
        CMEEncoder e = new CMEEncoder( getComponentId(), _majorVersion, _minorVersion, buf, offset );
