...
public final class CMEDecoderFull extends AbstractFixDecoder42 {
   ...
   // Constructors
    public CMEDecoderFull( String id ) {
        this( id, FixVersion.Fix4_2._major, FixVersion.Fix4_2._minor );
    }

    public CMEDecoderFull() {
        this( null, FixVersion.Fix4_2._major, FixVersion.Fix4_2._minor );
    }

    public CMEDecoderFull( byte major, byte minor ) {
        this( null, major, minor );
    }
    public CMEDecoderFull( String id, byte major, byte minor ) {
        super( major, minor );
        _id = id;
    }

    @Override public FixDecoder newInstance() {
        CMEDecoderFull dec = new CMEDecoderFull( getComponentId(), _majorVersion, _minorVersion );
