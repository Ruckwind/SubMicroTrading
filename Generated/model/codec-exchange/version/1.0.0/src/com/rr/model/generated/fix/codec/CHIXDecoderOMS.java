...
public final class CHIXDecoderOMS extends AbstractFixDecoder42 {
   ...
   // Constructors
    public CHIXDecoderOMS( String id ) {
        this( id, FixVersion.Fix4_2._major, FixVersion.Fix4_2._minor );
    }

    public CHIXDecoderOMS() {
        this( null, FixVersion.Fix4_2._major, FixVersion.Fix4_2._minor );
    }

    public CHIXDecoderOMS( byte major, byte minor ) {
        this( null, major, minor );
    }
    public CHIXDecoderOMS( String id, byte major, byte minor ) {
        super( major, minor );
        _id = id;
    }

    @Override public FixDecoder newInstance() {
        CHIXDecoderOMS dec = new CHIXDecoderOMS( getComponentId(), _majorVersion, _minorVersion );
