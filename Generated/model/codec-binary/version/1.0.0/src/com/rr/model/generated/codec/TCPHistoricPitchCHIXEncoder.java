...
public final class TCPHistoricPitchCHIXEncoder implements BinaryEncoder {
   ...
   // Constructors
    public TCPHistoricPitchCHIXEncoder( byte[] buf, int offset ) { this( null, buf, offset ); }

    public TCPHistoricPitchCHIXEncoder( String id, byte[] buf, int offset ) {
   ...
   // encode methods
    ...
    public final void encode( final Event msg ) {
        ...
        case EventIds.ID_PITCHBOOKADDORDER:
            encodeBookAddOrderA( (PitchBookAddOrder) msg );
            break;
        case EventIds.ID_PITCHBOOKORDEREXECUTED:
            encodeBookOrderExecutedA( (PitchBookOrderExecuted) msg );
            break;
        case EventIds.ID_PITCHBOOKCANCELORDER:
            encodeBookOrderCancelA( (PitchBookCancelOrder) msg );
            break;
    ...
    public final void encodeBookAddOrderA( final PitchBookAddOrder msg ) {
        final long now = _tzCalculator.getNowAsInternalTime();
        _builder.start( MSG_PitchBookAddOrder );
        if ( _debug ) {
            _dump.append( "  encodeMap=" ).append( "PitchBookAddOrder" ).append( "  eventType=" ).append( "PitchBookAddOrder" ).append( " : " );
        }
    ...
    public final void encodeBookAddOrderMid( final PitchBookAddOrder msg ) {
        final long now = _tzCalculator.getNowAsInternalTime();
        _builder.start( MSG_PitchBookAddOrderMid );
        if ( _debug ) {
            _dump.append( "  encodeMap=" ).append( "PitchBookAddOrderMid" ).append( "  eventType=" ).append( "PitchBookAddOrder" ).append( " : " );
        }
    ...
    public final void encodeBookAddOrderB( final PitchBookAddOrder msg ) {
        final long now = _tzCalculator.getNowAsInternalTime();
        _builder.start( MSG_PitchBookAddOrderLong );
        if ( _debug ) {
            _dump.append( "  encodeMap=" ).append( "PitchBookAddOrderLong" ).append( "  eventType=" ).append( "PitchBookAddOrder" ).append( " : " );
        }
    ...
    public final void encodeBookAddOrderC( final PitchBookAddOrder msg ) {
        final long now = _tzCalculator.getNowAsInternalTime();
        _builder.start( MSG_PitchBookAddOrderExpanded );
        if ( _debug ) {
            _dump.append( "  encodeMap=" ).append( "PitchBookAddOrderExpanded" ).append( "  eventType=" ).append( "PitchBookAddOrder" ).append( " : " );
        }
        ...
        final PitchOrderTypeIndicator tTypeIndic = msg.getTypeIndic();
        final byte tTypeIndicBytes = ( tTypeIndic != null ) ? tTypeIndic.getVal() : 0x00;
        _builder.encodeByte( tTypeIndicBytes );
        if ( _debug ) _dump.append( "\nField: " ).append( "participant" ).append( " : " );
        _builder.encodeFiller( 4 );    // participant
        _builder.end();
    }

    public final void encodeBookOrderExecutedA( final PitchBookOrderExecuted msg ) {
        final long now = _tzCalculator.getNowAsInternalTime();
        _builder.start( MSG_PitchBookOrderExecuted );
        if ( _debug ) {
            _dump.append( "  encodeMap=" ).append( "PitchBookOrderExecuted" ).append( "  eventType=" ).append( "PitchBookOrderExecuted" ).append( " : " );
        }
    ...
    public final void encodeBookOrderExecutedB( final PitchBookOrderExecuted msg ) {
        final long now = _tzCalculator.getNowAsInternalTime();
        _builder.start( MSG_PitchBookOrderExecutedLong );
        if ( _debug ) {
            _dump.append( "  encodeMap=" ).append( "PitchBookOrderExecutedLong" ).append( "  eventType=" ).append( "PitchBookOrderExecuted" ).append( " : " );
        }
    ...
    public final void encodeBookOrderCancelA( final PitchBookCancelOrder msg ) {
        final long now = _tzCalculator.getNowAsInternalTime();
        _builder.start( MSG_PitchBookCancelOrder );
        if ( _debug ) {
            _dump.append( "  encodeMap=" ).append( "PitchBookCancelOrder" ).append( "  eventType=" ).append( "PitchBookCancelOrder" ).append( " : " );
        }
    ...
    public final void encodeBookOrderCancelB( final PitchBookCancelOrder msg ) {
        final long now = _tzCalculator.getNowAsInternalTime();
        _builder.start( MSG_PitchBookCancelOrderLong );
        if ( _debug ) {
            _dump.append( "  encodeMap=" ).append( "PitchBookCancelOrderLong" ).append( "  eventType=" ).append( "PitchBookCancelOrder" ).append( " : " );
        }
    ...
    public final void encodeBookClearMicros( final PitchSymbolClear msg ) {
        final long now = _tzCalculator.getNowAsInternalTime();
        _builder.start( MSG_PitchSymbolClearMicros );
        if ( _debug ) {
            _dump.append( "  encodeMap=" ).append( "PitchSymbolClearMicros" ).append( "  eventType=" ).append( "PitchSymbolClear" ).append( " : " );
        }
