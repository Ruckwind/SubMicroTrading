...
public final class ClientX_44DecoderOMS extends AbstractFixDecoder44 {
   ...
   // Constructors
    public ClientX_44DecoderOMS( String id ) {
        this( id, FixVersion.Fix4_4._major, FixVersion.Fix4_4._minor );
    }

    public ClientX_44DecoderOMS() {
        this( null, FixVersion.Fix4_4._major, FixVersion.Fix4_4._minor );
    }

    public ClientX_44DecoderOMS( byte major, byte minor ) {
        this( null, major, minor );
    }
    public ClientX_44DecoderOMS( String id, byte major, byte minor ) {
        super( major, minor );
        _id = id;
    }

    @Override public FixDecoder newInstance() {
        ClientX_44DecoderOMS dec = new ClientX_44DecoderOMS( getComponentId(), _majorVersion, _minorVersion );
