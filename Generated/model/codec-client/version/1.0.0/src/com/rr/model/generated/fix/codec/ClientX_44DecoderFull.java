...
public final class ClientX_44DecoderFull extends AbstractFixDecoder44 {
   ...
   // Constructors
    public ClientX_44DecoderFull( String id ) {
        this( id, FixVersion.Fix4_4._major, FixVersion.Fix4_4._minor );
    }

    public ClientX_44DecoderFull() {
        this( null, FixVersion.Fix4_4._major, FixVersion.Fix4_4._minor );
    }

    public ClientX_44DecoderFull( byte major, byte minor ) {
        this( null, major, minor );
    }
    public ClientX_44DecoderFull( String id, byte major, byte minor ) {
        super( major, minor );
        _id = id;
    }

    @Override public FixDecoder newInstance() {
        ClientX_44DecoderFull dec = new ClientX_44DecoderFull( getComponentId(), _majorVersion, _minorVersion );
