...
public final class SampleBroker1Fix44Encoder implements FixEncoder {
   ...
   // Constructors
    public SampleBroker1Fix44Encoder( String id, byte[] buf, int offset ) {
        this( id, FixVersion.Fix4_4._major, FixVersion.Fix4_4._minor, buf, offset );
    }

    public SampleBroker1Fix44Encoder( byte[] buf, int offset ) {
        this( null, FixVersion.Fix4_4._major, FixVersion.Fix4_4._minor, buf, offset );
    }

    public SampleBroker1Fix44Encoder( byte major, byte minor, byte[] buf, int offset ) {
        this( null, major, minor, buf, offset );
    }

    public SampleBroker1Fix44Encoder( String id, byte major, byte minor, byte[] buf, int offset ) {
    ...
    public SampleBroker1Fix44Encoder( String id, byte major, byte minor, byte[] buf ) {
        this( id, major, minor, buf, 0 );
    }

    public SampleBroker1Fix44Encoder( byte major, byte minor, byte[] buf ) {
   ...
   // encode methods
    ...
    @Override public FixEncoder newInstance() {
        ...
        SampleBroker1Fix44Encoder e = new SampleBroker1Fix44Encoder( getComponentId(), _majorVersion, _minorVersion, buf, offset );
