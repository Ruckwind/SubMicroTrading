...
public final class MD44Encoder implements FixEncoder {
   ...
   // Constructors
    public MD44Encoder( String id, byte[] buf, int offset ) {
    ...
    public MD44Encoder( String id, byte major, byte minor, byte[] buf, int offset ) {
    ...
    public MD44Encoder( String id, byte major, byte minor, byte[] buf ) {
   ...
   // encode methods
    ...
    public final void encodeSecurityDefinition( final SecurityDefinition msg ) {
        ...
        _builder.encodeByte( 35, MSG_SecurityDefinition );
            ...
            _builder.encodeString( FixDictionaryMD44.TargetCompID, _targetCompId ); // tag56;
        _builder.encodeInt( FixDictionaryMD44.MsgSeqNum, msg.getMsgSeqNum() );        // tag34
            _builder.encodeUTCTimestamp( FixDictionaryMD44.SendingTime, msg.getEventTimestamp() ); // tag52;
    ...
    @Override public FixEncoder newInstance() {
        ...
        MD44Encoder e = new MD44Encoder( getComponentId(), _majorVersion, _minorVersion, buf, offset );
