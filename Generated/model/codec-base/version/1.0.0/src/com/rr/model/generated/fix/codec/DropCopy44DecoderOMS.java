...
public final class DropCopy44DecoderOMS extends AbstractFixDecoderDC44 {
   ...
   // Constructors
    public DropCopy44DecoderOMS( String id ) {
        this( id, FixVersion.Fix4_4._major, FixVersion.Fix4_4._minor );
    }

    public DropCopy44DecoderOMS() {
        this( null, FixVersion.Fix4_4._major, FixVersion.Fix4_4._minor );
    }

    public DropCopy44DecoderOMS( byte major, byte minor ) {
        this( null, major, minor );
    }
    public DropCopy44DecoderOMS( String id, byte major, byte minor ) {
        super( major, minor );
        _id = id;
    }

    @Override public FixDecoder newInstance() {
        DropCopy44DecoderOMS dec = new DropCopy44DecoderOMS( getComponentId(), _majorVersion, _minorVersion );
