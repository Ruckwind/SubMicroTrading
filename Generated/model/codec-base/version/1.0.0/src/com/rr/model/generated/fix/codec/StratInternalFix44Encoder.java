...
public final class StratInternalFix44Encoder implements FixEncoder {
   ...
   // Constructors
    public StratInternalFix44Encoder( String id, byte[] buf, int offset ) {
        this( id, FixVersion.Fix4_4._major, FixVersion.Fix4_4._minor, buf, offset );
    }

    public StratInternalFix44Encoder( byte[] buf, int offset ) {
        this( null, FixVersion.Fix4_4._major, FixVersion.Fix4_4._minor, buf, offset );
    }

    public StratInternalFix44Encoder( byte major, byte minor, byte[] buf, int offset ) {
        this( null, major, minor, buf, offset );
    }

    public StratInternalFix44Encoder( String id, byte major, byte minor, byte[] buf, int offset ) {
    ...
    public StratInternalFix44Encoder( String id, byte major, byte minor, byte[] buf ) {
        this( id, major, minor, buf, 0 );
    }

    public StratInternalFix44Encoder( byte major, byte minor, byte[] buf ) {
   ...
   // encode methods
    ...
    public final void encodeNewOrderSingle( final NewOrderSingle msg ) {
        ...
        _builder.encodeString( FixDictionary44.strategyId, msg.getStratId() );        // tag1601
        _builder.encodeString( FixDictionary44.origStrategyId, msg.getOrigStratId() );        // tag1602
    ...
    @Override public FixEncoder newInstance() {
        ...
        StratInternalFix44Encoder e = new StratInternalFix44Encoder( getComponentId(), _majorVersion, _minorVersion, buf, offset );
