...
public final class SampleBroker1Fix44DecoderFull extends AbstractFixDecoder44 {
   ...
   // Constructors
    public SampleBroker1Fix44DecoderFull( String id ) {
        this( id, FixVersion.Fix4_4._major, FixVersion.Fix4_4._minor );
    }

    public SampleBroker1Fix44DecoderFull() {
        this( null, FixVersion.Fix4_4._major, FixVersion.Fix4_4._minor );
    }

    public SampleBroker1Fix44DecoderFull( byte major, byte minor ) {
        this( null, major, minor );
    }
    public SampleBroker1Fix44DecoderFull( String id, byte major, byte minor ) {
        super( major, minor );
        _id = id;
    }

    @Override public FixDecoder newInstance() {
        SampleBroker1Fix44DecoderFull dec = new SampleBroker1Fix44DecoderFull( getComponentId(), _majorVersion, _minorVersion );
