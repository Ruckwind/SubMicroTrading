...
public final class Standard42DecoderFull extends AbstractFixDecoder42 {
   ...
   // Constructors
    public Standard42DecoderFull( String id ) {
        this( id, FixVersion.Fix4_2._major, FixVersion.Fix4_2._minor );
    }

    public Standard42DecoderFull() {
        this( null, FixVersion.Fix4_2._major, FixVersion.Fix4_2._minor );
    }

    public Standard42DecoderFull( byte major, byte minor ) {
        this( null, major, minor );
    }
    public Standard42DecoderFull( String id, byte major, byte minor ) {
        super( major, minor );
        _id = id;
    }

    @Override public FixDecoder newInstance() {
        Standard42DecoderFull dec = new Standard42DecoderFull( getComponentId(), _majorVersion, _minorVersion );
   ...
   // decode methods
    ...
    public final Event decodeNewOrderSingle() {
        ...
        while( _tag != 0 ) {
            ...
            case 42: case 45: case 46: case 51: case 53: case 61: case 62: case 63:  /* SKIP */
            ...
            case 88: case 89: case 90: case 91: case 92: case 93: case 94: case 95:  /* SKIP */
    ...
    public final Event decodeCancelReplaceRequest() {
        ...
        while( _tag != 0 ) {
            ...
            case 46: case 51: case 53: case 61: case 62: case 63: case 64: case 65:  /* SKIP */
