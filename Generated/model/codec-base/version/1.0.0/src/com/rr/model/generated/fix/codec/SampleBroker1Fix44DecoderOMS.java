...
public final class SampleBroker1Fix44DecoderOMS extends AbstractFixDecoder44 {
   ...
   // Constructors
    public SampleBroker1Fix44DecoderOMS( String id ) {
        this( id, FixVersion.Fix4_4._major, FixVersion.Fix4_4._minor );
    }

    public SampleBroker1Fix44DecoderOMS() {
        this( null, FixVersion.Fix4_4._major, FixVersion.Fix4_4._minor );
    }

    public SampleBroker1Fix44DecoderOMS( byte major, byte minor ) {
        this( null, major, minor );
    }
    public SampleBroker1Fix44DecoderOMS( String id, byte major, byte minor ) {
        super( major, minor );
        _id = id;
    }

    @Override public FixDecoder newInstance() {
        SampleBroker1Fix44DecoderOMS dec = new SampleBroker1Fix44DecoderOMS( getComponentId(), _majorVersion, _minorVersion );
