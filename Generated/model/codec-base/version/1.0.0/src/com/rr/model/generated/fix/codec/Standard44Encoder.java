...
public final class Standard44Encoder implements FixEncoder {
   ...
   // Constructors
    public Standard44Encoder( String id, byte[] buf, int offset ) {
    ...
    public Standard44Encoder( String id, byte major, byte minor, byte[] buf, int offset ) {
    ...
    public Standard44Encoder( String id, byte major, byte minor, byte[] buf ) {
   ...
   // encode methods
    ...
    @Override public FixEncoder newInstance() {
        ...
        Standard44Encoder e = new Standard44Encoder( getComponentId(), _majorVersion, _minorVersion, buf, offset );
