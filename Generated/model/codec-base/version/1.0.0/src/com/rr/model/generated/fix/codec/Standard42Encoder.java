...
public final class Standard42Encoder implements FixEncoder {
   ...
   // Constructors
    public Standard42Encoder( String id, byte[] buf, int offset ) {
    ...
    public Standard42Encoder( String id, byte major, byte minor, byte[] buf, int offset ) {
    ...
    public Standard42Encoder( String id, byte major, byte minor, byte[] buf ) {
   ...
   // encode methods
    ...
    @Override public FixEncoder newInstance() {
        ...
        Standard42Encoder e = new Standard42Encoder( getComponentId(), _majorVersion, _minorVersion, buf, offset );
