...
public final class MD44Decoder extends AbstractFixDecoderMD44 {
   ...
   // Constructors
    ...
    public MD44Decoder( String id, byte major, byte minor ) {
        super( major, minor );
        _id = id;
    }

    @Override public FixDecoder newInstance() {
        MD44Decoder dec = new MD44Decoder( getComponentId(), _majorVersion, _minorVersion );
