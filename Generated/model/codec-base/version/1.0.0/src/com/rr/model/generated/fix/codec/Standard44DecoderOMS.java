...
public final class Standard44DecoderOMS extends AbstractFixDecoder44 {
   ...
   // Constructors
    public Standard44DecoderOMS( String id ) {
        this( id, FixVersion.Fix4_4._major, FixVersion.Fix4_4._minor );
    }

    public Standard44DecoderOMS() {
        this( null, FixVersion.Fix4_4._major, FixVersion.Fix4_4._minor );
    }

    public Standard44DecoderOMS( byte major, byte minor ) {
        this( null, major, minor );
    }
    public Standard44DecoderOMS( String id, byte major, byte minor ) {
        super( major, minor );
        _id = id;
    }

    @Override public FixDecoder newInstance() {
        Standard44DecoderOMS dec = new Standard44DecoderOMS( getComponentId(), _majorVersion, _minorVersion );
