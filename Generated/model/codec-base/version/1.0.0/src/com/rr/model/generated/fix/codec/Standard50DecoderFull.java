...
public final class Standard50DecoderFull extends AbstractFixDecoder50 {
   ...
   // Constructors
    public Standard50DecoderFull( String id ) {
        this( id, FixVersion.Fix5_0._major, FixVersion.Fix5_0._minor );
    }

    public Standard50DecoderFull() {
        this( null, FixVersion.Fix5_0._major, FixVersion.Fix5_0._minor );
    }

    public Standard50DecoderFull( byte major, byte minor ) {
        this( null, major, minor );
    }
    public Standard50DecoderFull( String id, byte major, byte minor ) {
        super( major, minor );
        _id = id;
    }

    @Override public FixDecoder newInstance() {
        Standard50DecoderFull dec = new Standard50DecoderFull( getComponentId(), _majorVersion, _minorVersion );
