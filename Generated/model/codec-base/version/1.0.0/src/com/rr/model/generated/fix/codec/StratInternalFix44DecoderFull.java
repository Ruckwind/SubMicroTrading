...
public final class StratInternalFix44DecoderFull extends AbstractFixDecoder44 {
   ...
   // write String start and length vars required for ExecRpts
    ...
    int _stratIdStart = 0;    // tag null
    int _stratIdLen = 0;    // tag null
    int _origStratIdStart = 0;    // tag null
    int _origStratIdLen = 0;    // tag null
   ...
   // Constructors
    public StratInternalFix44DecoderFull( String id ) {
        this( id, FixVersion.Fix4_4._major, FixVersion.Fix4_4._minor );
    }

    public StratInternalFix44DecoderFull() {
        this( null, FixVersion.Fix4_4._major, FixVersion.Fix4_4._minor );
    }

    public StratInternalFix44DecoderFull( byte major, byte minor ) {
        this( null, major, minor );
    }
    public StratInternalFix44DecoderFull( String id, byte major, byte minor ) {
        super( major, minor );
        _id = id;
    }

    @Override public FixDecoder newInstance() {
        StratInternalFix44DecoderFull dec = new StratInternalFix44DecoderFull( getComponentId(), _majorVersion, _minorVersion );
   ...
   // decode methods
    ...
    public final Event decodeExecReport() {
        ...
        _stratIdStart = 0;    // tag null
        _stratIdLen = 0;    // tag null
        _origStratIdStart = 0;    // tag null
        _origStratIdLen = 0;    // tag null
        ...
        while( _tag != 0 ) {
            ...
            case 75:         // tag75
            case 76:         // tag76
            case FixDictionary44.PositionEffect:         // tag77
            case 78:         // tag78
            case 79:         // tag79
            case 80:         // tag80
            case 81:         // tag81
            ...
            case 87:         // tag87
            case 88:         // tag88
            case FixDictionary44.Signature:         // tag89
            case 90:         // tag90
            case 91:         // tag91
            case 92:         // tag92
            case FixDictionary44.SignatureLength:         // tag93
            case 94:         // tag94
            case FixDictionary44.RawDataLen:         // tag95
            case FixDictionary44.RawData:         // tag96
            case FixDictionary44.PossResend:         // tag97
            case FixDictionary44.EncryptMethod:         // tag98
            case 99:         // tag99
            case FixDictionary44.ExDest:         // tag100
            case 101:         // tag101
            case FixDictionary44.CxlRejReason:         // tag102
            case FixDictionary44.OrdRejReason:         // tag103
            case 104:         // tag104
            case 105:         // tag105
            case 106:         // tag106
            case FixDictionary44.heartBtInt:         // tag108
            case FixDictionary44.clientID:         // tag109
            case 110:         // tag110
            case FixDictionary44.displayQty:         // tag111
            case FixDictionary44.testReqID:         // tag112
            case 113:         // tag113
            case 114:         // tag114
            case FixDictionary44.OnBehalfOfCompID:         // tag115
            case FixDictionary44.OnBehalfOfSubID:         // tag116
            case 117:         // tag117
            case 118:         // tag118
            case 119:         // tag119
            case FixDictionary44.settlCurrency:         // tag120
            case 121:         // tag121
            case FixDictionary44.OrigSendingTime:         // tag122
            case FixDictionary44.GapFillFlag:         // tag123
            case 124:         // tag124
            case 125:         // tag125
            case FixDictionary44.expireTime:         // tag126
            case 127:         // tag127
            case FixDictionary44.DeliverToCompID:         // tag128
                getValLength();
                break;
            default:
                switch( _tag ) {
                ...
                case FixDictionary44.LeavesQty:         // tag151
                    ...
                    break;
                case FixDictionary44.parentClOrdId:         // tag526
                    _parentClOrdIdStart = _idx;
                    _parentClOrdIdLen = getValLength();
                    break;
                case FixDictionary44.strategyId:         // tag1601
                    _stratIdStart = _idx;
                    _stratIdLen = getValLength();
                    break;
                case FixDictionary44.origStrategyId:         // tag1602
                    _origStratIdStart = _idx;
                    _origStratIdLen = getValLength();
                    break;
                case FixDictionary44.MultiLegReportingType:         // tag442
                     _multiLegReportingType = MultiLegReportingType.getVal( _fixMsg[_idx++] );
                    break;
                case FixDictionary44.LiquidityInd:         // tag851
                     _liquidityInd = LiquidityInd.getVal( _fixMsg[_idx++] );
                    break;
                case FixDictionary44.TradingStatus:         // tag1700
                    start = _idx;
                    valLen = getValLength();
    ...
    public final Event populateExecRptNew() {
        ...
        if ( _stratIdLen > 0 ) msg.setStratId( _fixMsg, _stratIdStart, _stratIdLen );
        if ( _origStratIdLen > 0 ) msg.setOrigStratId( _fixMsg, _origStratIdStart, _origStratIdLen );
        return msg;
    }
        ...
        while( _tag != 0 ) {
            ...
            default:
                ...
                case FixDictionary44.expireTime:         // tag126
                    ...
                    break;
                case FixDictionary44.effectiveTime:         // tag168
                    msg.setEffectiveTime( getInternalTime() );
                    break;
                case FixDictionary44.maturityMonthYear:         // tag200
                ...
                case FixDictionary44.BookingType:         // tag775
                    ...
                    break;
                case FixDictionary44.TargetStrategy:         // tag847
                    msg.setTargetStrategy( TargetStrategy.getVal( _fixMsg[_idx++] ) );
                    break;
                case FixDictionary44.strategyId:         // tag1601
                    start = _idx;
                    valLen = getValLength();
                    msg.setStratId( _fixMsg, start, valLen );
                    break;
                case FixDictionary44.origStrategyId:         // tag1602
                    start = _idx;
                    valLen = getValLength();
                    msg.setOrigStratId( _fixMsg, start, valLen );
                    break;
                default:
                    getValLength();
                    break;
