...
public final class MD50Encoder implements FixEncoder {
   ...
   // Constructors
    public MD50Encoder( String id, byte[] buf, int offset ) {
    ...
    public MD50Encoder( String id, byte major, byte minor, byte[] buf, int offset ) {
    ...
    public MD50Encoder( String id, byte major, byte minor, byte[] buf ) {
   ...
   // encode methods
    ...
    @Override public FixEncoder newInstance() {
        ...
        MD50Encoder e = new MD50Encoder( getComponentId(), _majorVersion, _minorVersion, buf, offset );
