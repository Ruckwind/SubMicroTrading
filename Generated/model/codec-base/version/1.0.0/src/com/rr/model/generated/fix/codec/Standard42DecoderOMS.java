...
public final class Standard42DecoderOMS extends AbstractFixDecoder42 {
   ...
   // Constructors
    public Standard42DecoderOMS( String id ) {
        this( id, FixVersion.Fix4_2._major, FixVersion.Fix4_2._minor );
    }

    public Standard42DecoderOMS() {
        this( null, FixVersion.Fix4_2._major, FixVersion.Fix4_2._minor );
    }

    public Standard42DecoderOMS( byte major, byte minor ) {
        this( null, major, minor );
    }
    public Standard42DecoderOMS( String id, byte major, byte minor ) {
        super( major, minor );
        _id = id;
    }

    @Override public FixDecoder newInstance() {
        Standard42DecoderOMS dec = new Standard42DecoderOMS( getComponentId(), _majorVersion, _minorVersion );
