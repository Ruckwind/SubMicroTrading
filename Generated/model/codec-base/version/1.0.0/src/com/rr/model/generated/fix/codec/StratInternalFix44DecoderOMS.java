...
public final class StratInternalFix44DecoderOMS extends AbstractFixDecoder44 {
   ...
   // Constructors
    public StratInternalFix44DecoderOMS( String id ) {
        this( id, FixVersion.Fix4_4._major, FixVersion.Fix4_4._minor );
    }

    public StratInternalFix44DecoderOMS() {
        this( null, FixVersion.Fix4_4._major, FixVersion.Fix4_4._minor );
    }

    public StratInternalFix44DecoderOMS( byte major, byte minor ) {
        this( null, major, minor );
    }
    public StratInternalFix44DecoderOMS( String id, byte major, byte minor ) {
        super( major, minor );
        _id = id;
    }

    @Override public FixDecoder newInstance() {
        StratInternalFix44DecoderOMS dec = new StratInternalFix44DecoderOMS( getComponentId(), _majorVersion, _minorVersion );
        ...
        while( _tag != 0 ) {
            ...
            default:
                ...
                case FixDictionary44.strategyId:         // tag1601
                    start = _idx - _offset;
                    valLen = getValLength();
                    msg.setStratId( start, valLen );
                    break;
                case FixDictionary44.origStrategyId:         // tag1602
                    start = _idx - _offset;
                    valLen = getValLength();
                    msg.setOrigStratId( start, valLen );
                    break;
                default:
                    getValLength();
                    break;
