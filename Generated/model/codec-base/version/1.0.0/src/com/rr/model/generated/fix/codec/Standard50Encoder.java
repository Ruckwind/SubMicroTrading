...
public final class Standard50Encoder implements FixEncoder {
   ...
   // Constructors
    public Standard50Encoder( String id, byte[] buf, int offset ) {
        this( id, FixVersion.Fix5_0._major, FixVersion.Fix5_0._minor, buf, offset );
    }

    public Standard50Encoder( byte[] buf, int offset ) {
        this( null, FixVersion.Fix5_0._major, FixVersion.Fix5_0._minor, buf, offset );
    }
    ...
    public Standard50Encoder( String id, byte major, byte minor, byte[] buf, int offset ) {
    ...
    public Standard50Encoder( String id, byte major, byte minor, byte[] buf ) {
   ...
   // encode methods
    ...
    public final void encodeNewOrderSingle( final NewOrderSingle msg ) {
        ...
        _builder.encodeLong( FixDictionary50.OrderQty, (long)msg.getOrderQty() );        // tag38
        ...
        _builder.encodeInt( FixDictionary50.maturityMonthYear, msg.getMaturityMonthYear() );        // tag200
        ...
        if ( tSecurityExchange != null ) _builder.encodeBytes( FixDictionary50.SecurityExchange, tSecurityExchange.getVal() );        // tag207
        ...
        if ( tTargetStrategy != null ) _builder.encodeByte( FixDictionary50.TargetStrategy, tTargetStrategy.getVal() );        // tag847
        _builder.encodeUTCTimestamp( FixDictionary50.effectiveTime, msg.getEffectiveTime() );        // tag168
        _builder.encodeUTCTimestamp( FixDictionary50.expireTime, msg.getExpireTime() );        // tag126
        _builder.encodeString( FixDictionary50.parentClOrdId, msg.getParentClOrdId() );        // tag526
    ...
    public final void encodeNewOrderAck( final NewOrderAck msg ) {
        ...
        _builder.encodeLong( FixDictionary50.CumQty, (long)msg.getCumQty() );        // tag14
        _builder.encodeString( FixDictionary50.Text, msg.getText() );        // tag58
        _builder.encodeLong( FixDictionary50.LeavesQty, (long)msg.getLeavesQty() );        // tag151
        _builder.encodeString( FixDictionary50.parentClOrdId, msg.getParentClOrdId() );        // tag526
        _builder.encodeEnvelope();
    }
    ...
    public final void encodeTradeNew( final TradeNew msg ) {
        ...
        _builder.encodeLong( FixDictionary50.LeavesQty, (long)msg.getLeavesQty() );        // tag151
        _builder.encodeString( FixDictionary50.parentClOrdId, msg.getParentClOrdId() );        // tag526
        _builder.encodeLong( FixDictionary50.LastQty, (long)msg.getLastQty() );        // tag32
        ...
        if ( tLiquidityInd != null ) _builder.encodeByte( FixDictionary50.LiquidityInd, tLiquidityInd.getVal() );        // tag851
        _builder.encodeEnvelope();
    }
    ...
    public final void encodeRejected( final Rejected msg ) {
        ...
        if ( tTradingStatus != null ) _builder.encodeTwoByte( FixDictionary50.TradingStatus, tTradingStatus.getVal() );        // tag1700
        _builder.encodeEnvelope();
    }
    ...
    @Override public FixEncoder newInstance() {
        ...
        Standard50Encoder e = new Standard50Encoder( getComponentId(), _majorVersion, _minorVersion, buf, offset );
