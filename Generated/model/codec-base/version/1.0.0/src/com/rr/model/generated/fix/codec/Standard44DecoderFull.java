...
public final class Standard44DecoderFull extends AbstractFixDecoder44 {
   ...
   // Constructors
    public Standard44DecoderFull( String id ) {
        this( id, FixVersion.Fix4_4._major, FixVersion.Fix4_4._minor );
    }

    public Standard44DecoderFull() {
        this( null, FixVersion.Fix4_4._major, FixVersion.Fix4_4._minor );
    }

    public Standard44DecoderFull( byte major, byte minor ) {
        this( null, major, minor );
    }
    public Standard44DecoderFull( String id, byte major, byte minor ) {
        super( major, minor );
        _id = id;
    }

    @Override public FixDecoder newInstance() {
        Standard44DecoderFull dec = new Standard44DecoderFull( getComponentId(), _majorVersion, _minorVersion );
