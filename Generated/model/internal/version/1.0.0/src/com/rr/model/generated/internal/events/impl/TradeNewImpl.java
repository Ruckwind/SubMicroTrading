...
public final class TradeNewImpl implements TradeBase, TradeNewWrite, Copyable<TradeNew>, MarketTradeNewWrite, Reusable<TradeNewImpl> {

   // Attrs

    private transient          TradeNewImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.TradeNew;
    }

    @Override
    public final TradeNewImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( TradeNewImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( final ReusableString out ) {
        out.append( "TradeNewImpl" ).append( ' ' );
    ...
    @Override public final void snapTo( TradeNew dest ) {
        ((TradeNewImpl)dest).deepCopyFrom( this );
    }

    /** DEEP copy all members ... INCLUDING subEvents : WARNING CREATES NEW OBJECTS SO MONITOR FOR GC */
    @Override public final void deepCopyFrom( TradeNew src ) {
    ...
    @Override public final void shallowCopyFrom( TradeNew src ) {
        setLastQty( src.getLastQty() );
        setLastPx( src.getLastPx() );
        setLiquidityInd( src.getLiquidityInd() );
        setMultiLegReportingType( src.getMultiLegReportingType() );
    ...
    /** shallow copy all primitive members ... EXCLUDING subEvents */
    @Override public final void shallowMergeFrom( TradeNew src ) {
