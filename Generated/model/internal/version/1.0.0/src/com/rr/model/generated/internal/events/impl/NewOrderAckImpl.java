...
public final class NewOrderAckImpl implements CommonExecRpt, NewOrderAckWrite, Copyable<NewOrderAck>, MarketNewOrderAckWrite, Reusable<NewOrderAckImpl> {

   // Attrs

    private transient          NewOrderAckImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.NewOrderAck;
    }

    @Override
    public final NewOrderAckImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( NewOrderAckImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( final ReusableString out ) {
        out.append( "NewOrderAckImpl" ).append( ' ' );
        if ( Constants.UNSET_LONG != getAckReceived() && 0 != getAckReceived() )             out.append( ", ackReceived=" ).append( getAckReceived() );
    ...
    @Override public final void snapTo( NewOrderAck dest ) {
        ((NewOrderAckImpl)dest).deepCopyFrom( this );
    }

    /** DEEP copy all members ... INCLUDING subEvents : WARNING CREATES NEW OBJECTS SO MONITOR FOR GC */
    @Override public final void deepCopyFrom( NewOrderAck src ) {
        setAckReceived( src.getAckReceived() );
    ...
    @Override public final void shallowCopyFrom( NewOrderAck src ) {
        setAckReceived( src.getAckReceived() );
        setOrderReceived( src.getOrderReceived() );
        setOrderSent( src.getOrderSent() );
        getExecIdForUpdate().copy( src.getExecId() );
    ...
    /** shallow copy all primitive members ... EXCLUDING subEvents */
    @Override public final void shallowMergeFrom( NewOrderAck src ) {
        if ( Constants.UNSET_LONG != src.getAckReceived() ) setAckReceived( src.getAckReceived() );
