...
public final class MarketExpiredImpl implements CommonExecRpt, MarketExpiredWrite, Reusable<MarketExpiredImpl> {
   ...
   // Attrs
    ...
    private transient          MarketExpiredImpl _next = null;
   ...
   // Getters and Setters
    ...
    @Override public double getOrderQty() { throw new IllegalFieldAccess( "Getter for orderQty event Expired is a delegate field from order request base" ); }
