...
public final class MarketStoppedImpl implements CommonExecRpt, MarketStoppedWrite, Reusable<MarketStoppedImpl> {
   ...
   // Attrs
    ...
    private transient          MarketStoppedImpl _next = null;
   ...
   // Getters and Setters
    ...
    @Override public double getOrderQty() { throw new IllegalFieldAccess( "Getter for orderQty event Stopped is a delegate field from order request base" ); }
