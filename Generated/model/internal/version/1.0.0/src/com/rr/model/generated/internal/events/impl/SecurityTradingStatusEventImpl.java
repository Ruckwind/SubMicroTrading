...
public final class SecurityTradingStatusEventImpl implements CommonHeader, SecurityTradingStatusEventWrite, Copyable<SecurityTradingStatusEvent>, Reusable<SecurityTradingStatusEventImpl> {

   // Attrs

    private transient          SecurityTradingStatusEventImpl _next = null;
   ...
   // Getters and Setters
    ...
    @Override public final SecurityTradingStatus getTradingStatus() { return _tradingStatus; }
    @Override public final void setTradingStatus( SecurityTradingStatus val ) { _tradingStatus = val; }
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.SecurityTradingStatusEvent;
    }

    @Override
    public final SecurityTradingStatusEventImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( SecurityTradingStatusEventImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( final ReusableString out ) {
        out.append( "SecurityTradingStatusEventImpl" ).append( ' ' );
    ...
    @Override public final void snapTo( SecurityTradingStatusEvent dest ) {
        ((SecurityTradingStatusEventImpl)dest).deepCopyFrom( this );
    }

    /** DEEP copy all members ... INCLUDING subEvents : WARNING CREATES NEW OBJECTS SO MONITOR FOR GC */
    @Override public final void deepCopyFrom( SecurityTradingStatusEvent src ) {
        ...
        setTradingStatus( src.getTradingStatus() );
    ...
    @Override public final void shallowCopyFrom( SecurityTradingStatusEvent src ) {
        setDataSrc( src.getDataSrc() );
        setInstrument( src.getInstrument() );
        getSubjectForUpdate().copy( src.getSubject() );
        setDataSeqNum( src.getDataSeqNum() );
    ...
    /** shallow copy all primitive members ... EXCLUDING subEvents */
    @Override public final void shallowMergeFrom( SecurityTradingStatusEvent src ) {
