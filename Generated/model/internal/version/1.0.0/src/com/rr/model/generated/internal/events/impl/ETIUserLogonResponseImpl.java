...
public final class ETIUserLogonResponseImpl implements BaseETIResponse, ETIUserLogonResponseWrite, Copyable<ETIUserLogonResponse>, Reusable<ETIUserLogonResponseImpl> {

   // Attrs

    private transient          ETIUserLogonResponseImpl _next = null;
   ...
   // Helper methods
    ...
    @Override public final void snapTo( ETIUserLogonResponse dest ) {
        ((ETIUserLogonResponseImpl)dest).deepCopyFrom( this );
    }

    /** DEEP copy all members ... INCLUDING subEvents : WARNING CREATES NEW OBJECTS SO MONITOR FOR GC */
    @Override public final void deepCopyFrom( ETIUserLogonResponse src ) {
    ...
    @Override public final void shallowCopyFrom( ETIUserLogonResponse src ) {
        setRequestTime( src.getRequestTime() );
        setMsgSeqNum( src.getMsgSeqNum() );
        setPossDupFlag( src.getPossDupFlag() );
        setEventTimestamp( src.getEventTimestamp() );
    ...
    /** shallow copy all primitive members ... EXCLUDING subEvents */
    @Override public final void shallowMergeFrom( ETIUserLogonResponse src ) {
