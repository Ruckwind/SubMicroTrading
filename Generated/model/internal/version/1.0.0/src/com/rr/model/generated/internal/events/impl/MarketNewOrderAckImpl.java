...
public final class MarketNewOrderAckImpl implements CommonExecRpt, MarketNewOrderAckWrite, Reusable<MarketNewOrderAckImpl> {
   ...
   // Attrs
    ...
    private transient          MarketNewOrderAckImpl _next = null;
   ...
   // Getters and Setters
    ...
    @Override public double getOrderQty() { throw new IllegalFieldAccess( "Getter for orderQty event NewOrderAck is a delegate field from order request base" ); }
