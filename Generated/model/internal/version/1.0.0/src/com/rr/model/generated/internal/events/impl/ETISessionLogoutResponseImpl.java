...
public final class ETISessionLogoutResponseImpl implements BaseETIResponse, ETISessionLogoutResponseWrite, Copyable<ETISessionLogoutResponse>, Reusable<ETISessionLogoutResponseImpl> {

   // Attrs

    private transient          ETISessionLogoutResponseImpl _next = null;
   ...
   // Helper methods
    ...
    @Override public final void snapTo( ETISessionLogoutResponse dest ) {
        ((ETISessionLogoutResponseImpl)dest).deepCopyFrom( this );
    }

    /** DEEP copy all members ... INCLUDING subEvents : WARNING CREATES NEW OBJECTS SO MONITOR FOR GC */
    @Override public final void deepCopyFrom( ETISessionLogoutResponse src ) {
    ...
    @Override public final void shallowCopyFrom( ETISessionLogoutResponse src ) {
        setRequestTime( src.getRequestTime() );
        setMsgSeqNum( src.getMsgSeqNum() );
        setPossDupFlag( src.getPossDupFlag() );
        setEventTimestamp( src.getEventTimestamp() );
    ...
    /** shallow copy all primitive members ... EXCLUDING subEvents */
    @Override public final void shallowMergeFrom( ETISessionLogoutResponse src ) {
