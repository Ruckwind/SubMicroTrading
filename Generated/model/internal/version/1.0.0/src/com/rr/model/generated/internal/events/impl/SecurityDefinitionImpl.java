...
public final class SecurityDefinitionImpl implements BaseMDResponse, SecurityDefinitionWrite, Copyable<SecurityDefinition>, Reusable<SecurityDefinitionImpl> {

   // Attrs

    private transient          SecurityDefinitionImpl _next = null;
   ...
   // Helper methods
    ...
    @Override public final void snapTo( SecurityDefinition dest ) {
        ((SecurityDefinitionImpl)dest).deepCopyFrom( this );
    }

    /** DEEP copy all members ... INCLUDING subEvents : WARNING CREATES NEW OBJECTS SO MONITOR FOR GC */
    @Override public final void deepCopyFrom( SecurityDefinition src ) {
    ...
    @Override public final void shallowCopyFrom( SecurityDefinition src ) {
        setTotNumReports( src.getTotNumReports() );
        setSecurityTradingStatus( src.getSecurityTradingStatus() );
        setSecurityType( src.getSecurityType() );
        setUniqueInstId( src.getUniqueInstId() );
    ...
    /** shallow copy all primitive members ... EXCLUDING subEvents */
    @Override public final void shallowMergeFrom( SecurityDefinition src ) {
