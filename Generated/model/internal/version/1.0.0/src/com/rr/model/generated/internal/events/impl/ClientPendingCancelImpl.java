...
public final class ClientPendingCancelImpl implements CommonExecRpt, ClientPendingCancelUpdate, Reusable<ClientPendingCancelImpl> {

   // Attrs

    private transient          ClientPendingCancelImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.ClientPendingCancel;
    }

    @Override
    public final ClientPendingCancelImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( ClientPendingCancelImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( final ReusableString out ) {
        out.append( "ClientPendingCancelImpl" ).append( ' ' );
