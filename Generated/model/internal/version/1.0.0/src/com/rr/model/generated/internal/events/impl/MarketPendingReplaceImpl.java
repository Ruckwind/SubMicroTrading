...
public final class MarketPendingReplaceImpl implements CommonExecRpt, MarketPendingReplaceWrite, Reusable<MarketPendingReplaceImpl> {

   // Attrs

    private transient          MarketPendingReplaceImpl _next = null;
   ...
   // Getters and Setters
    ...
    @Override public ViewString getSecurityId() { throw new IllegalFieldAccess( "Getter for securityId event PendingReplace is a delegate field from order request base" ); }


    @Override public ViewString getSymbol() { throw new IllegalFieldAccess( "Getter for symbol event PendingReplace is a delegate field from order request base" ); }


    @Override public Currency getCurrency() { throw new IllegalFieldAccess( "Getter for currency event PendingReplace is a delegate field from order request base" ); }


    @Override public SecurityIDSource getSecurityIDSource() { throw new IllegalFieldAccess( "Getter for securityIDSource event PendingReplace is a delegate field from order request base" ); }
    ...
    @Override public double getOrderQty() { throw new IllegalFieldAccess( "Getter for orderQty event PendingReplace is a delegate field from order request base" ); }


    @Override public double getPrice() { throw new IllegalFieldAccess( "Getter for price event PendingReplace is a delegate field from order request base" ); }
    ...
    @Override public ViewString getOnBehalfOfId() { throw new IllegalFieldAccess( "Getter for onBehalfOfId event PendingReplace is a delegate field from order request base" ); }
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.MarketPendingReplace;
    }

    @Override
    public final MarketPendingReplaceImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( MarketPendingReplaceImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( final ReusableString out ) {
        out.append( "MarketPendingReplaceImpl" ).append( ' ' );
