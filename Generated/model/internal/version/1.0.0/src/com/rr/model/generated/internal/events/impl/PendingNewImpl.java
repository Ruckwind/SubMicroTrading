...
public final class PendingNewImpl implements CommonExecRpt, PendingNewWrite, Copyable<PendingNew>, MarketPendingNewWrite, Reusable<PendingNewImpl> {

   // Attrs

    private transient          PendingNewImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.PendingNew;
    }

    @Override
    public final PendingNewImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( PendingNewImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( final ReusableString out ) {
        out.append( "PendingNewImpl" ).append( ' ' );
    ...
    @Override public final void snapTo( PendingNew dest ) {
        ((PendingNewImpl)dest).deepCopyFrom( this );
    }

    /** DEEP copy all members ... INCLUDING subEvents : WARNING CREATES NEW OBJECTS SO MONITOR FOR GC */
    @Override public final void deepCopyFrom( PendingNew src ) {
    ...
    @Override public final void shallowCopyFrom( PendingNew src ) {
        getExecIdForUpdate().copy( src.getExecId() );
        getClOrdIdForUpdate().copy( src.getClOrdId() );
        getSecurityIdForUpdate().copy( src.getSecurityId() );
        getSymbolForUpdate().copy( src.getSymbol() );
    ...
    /** shallow copy all primitive members ... EXCLUDING subEvents */
    @Override public final void shallowMergeFrom( PendingNew src ) {
