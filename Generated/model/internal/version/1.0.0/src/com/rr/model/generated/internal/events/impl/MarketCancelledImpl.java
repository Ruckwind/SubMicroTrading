...
public final class MarketCancelledImpl implements CommonExecRpt, MarketCancelledWrite, Reusable<MarketCancelledImpl> {
   ...
   // Attrs
    ...
    private transient          MarketCancelledImpl _next = null;
   ...
   // Getters and Setters
    ...
    @Override public double getOrderQty() { throw new IllegalFieldAccess( "Getter for orderQty event Cancelled is a delegate field from order request base" ); }
