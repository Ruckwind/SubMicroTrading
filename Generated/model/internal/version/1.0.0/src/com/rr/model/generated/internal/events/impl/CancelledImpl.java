...
public final class CancelledImpl implements CommonExecRpt, CancelledWrite, Copyable<Cancelled>, MarketCancelledWrite, Reusable<CancelledImpl> {

   // Attrs

    private transient          CancelledImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.Cancelled;
    }

    @Override
    public final CancelledImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( CancelledImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( final ReusableString out ) {
        out.append( "CancelledImpl" ).append( ' ' );
    ...
    @Override public final void snapTo( Cancelled dest ) {
        ((CancelledImpl)dest).deepCopyFrom( this );
    }

    /** DEEP copy all members ... INCLUDING subEvents : WARNING CREATES NEW OBJECTS SO MONITOR FOR GC */
    @Override public final void deepCopyFrom( Cancelled src ) {
    ...
    @Override public final void shallowCopyFrom( Cancelled src ) {
        getClOrdIdForUpdate().copy( src.getClOrdId() );
        getOrigClOrdIdForUpdate().copy( src.getOrigClOrdId() );
        getExecIdForUpdate().copy( src.getExecId() );
        getSecurityIdForUpdate().copy( src.getSecurityId() );
    ...
    /** shallow copy all primitive members ... EXCLUDING subEvents */
    @Override public final void shallowMergeFrom( Cancelled src ) {
