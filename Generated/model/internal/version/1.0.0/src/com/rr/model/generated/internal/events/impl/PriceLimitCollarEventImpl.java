...
public final class PriceLimitCollarEventImpl implements CommonHeader, PriceLimitCollarEventWrite, Copyable<PriceLimitCollarEvent>, Reusable<PriceLimitCollarEventImpl> {

   // Attrs

    private transient          PriceLimitCollarEventImpl _next = null;
    ...
    private double _lowLimitPrice = Constants.UNSET_DOUBLE;
    private double _highLimitPrice = Constants.UNSET_DOUBLE;
   ...
   // Getters and Setters
    ...
    @Override public final double getLowLimitPrice() { return _lowLimitPrice; }
    @Override public final void setLowLimitPrice( double val ) { _lowLimitPrice = val; }

    @Override public final double getHighLimitPrice() { return _highLimitPrice; }
    @Override public final void setHighLimitPrice( double val ) { _highLimitPrice = val; }
   ...
   // Reusable Contract
    ...
    public final void reset() {
        ...
        _lowLimitPrice = Constants.UNSET_DOUBLE;
        _highLimitPrice = Constants.UNSET_DOUBLE;
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.PriceLimitCollarEvent;
    }

    @Override
    public final PriceLimitCollarEventImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( PriceLimitCollarEventImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( final ReusableString out ) {
        out.append( "PriceLimitCollarEventImpl" ).append( ' ' );
        ...
        if ( Utils.hasVal( getLowLimitPrice() ) ) out.append( ", lowLimitPrice=" ).append( getLowLimitPrice() );
        if ( Utils.hasVal( getHighLimitPrice() ) ) out.append( ", highLimitPrice=" ).append( getHighLimitPrice() );
    ...
    @Override public final void snapTo( PriceLimitCollarEvent dest ) {
        ((PriceLimitCollarEventImpl)dest).deepCopyFrom( this );
    }

    /** DEEP copy all members ... INCLUDING subEvents : WARNING CREATES NEW OBJECTS SO MONITOR FOR GC */
    @Override public final void deepCopyFrom( PriceLimitCollarEvent src ) {
        ...
        setLowLimitPrice( src.getLowLimitPrice() );
        setHighLimitPrice( src.getHighLimitPrice() );
    ...
    @Override public final void shallowCopyFrom( PriceLimitCollarEvent src ) {
        setDataSrc( src.getDataSrc() );
        setInstrument( src.getInstrument() );
        getSubjectForUpdate().copy( src.getSubject() );
        setDataSeqNum( src.getDataSeqNum() );
    ...
    /** shallow copy all primitive members ... EXCLUDING subEvents */
    @Override public final void shallowMergeFrom( PriceLimitCollarEvent src ) {
        ...
        if ( Utils.hasVal( src.getLowLimitPrice() ) ) setLowLimitPrice( src.getLowLimitPrice() );
        if ( Utils.hasVal( src.getHighLimitPrice() ) ) setHighLimitPrice( src.getHighLimitPrice() );
