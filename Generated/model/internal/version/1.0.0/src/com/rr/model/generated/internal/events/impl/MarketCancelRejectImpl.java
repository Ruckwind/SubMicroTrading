...
public final class MarketCancelRejectImpl implements CommonExchangeHeader, MarketCancelRejectWrite, Reusable<MarketCancelRejectImpl> {
   ...
   // Attrs
    ...
    private transient          MarketCancelRejectImpl _next = null;
   ...
   // Getters and Setters
    ...
    @Override public ViewString getSecurityId() { throw new IllegalFieldAccess( "Getter for securityId event CancelReject is a delegate field from order request base" ); }


    @Override public ViewString getSymbol() { throw new IllegalFieldAccess( "Getter for symbol event CancelReject is a delegate field from order request base" ); }


    @Override public SecurityIDSource getSecurityIDSource() { throw new IllegalFieldAccess( "Getter for securityIDSource event CancelReject is a delegate field from order request base" ); }
