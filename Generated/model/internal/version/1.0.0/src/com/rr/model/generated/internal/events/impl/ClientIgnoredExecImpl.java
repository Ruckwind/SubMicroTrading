...
public final class ClientIgnoredExecImpl implements CommonExecRpt, ClientIgnoredExecUpdate, Reusable<ClientIgnoredExecImpl> {

   // Attrs

    private transient          ClientIgnoredExecImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.ClientIgnoredExec;
    }

    @Override
    public final ClientIgnoredExecImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( ClientIgnoredExecImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( final ReusableString out ) {
        out.append( "ClientIgnoredExecImpl" ).append( ' ' );
