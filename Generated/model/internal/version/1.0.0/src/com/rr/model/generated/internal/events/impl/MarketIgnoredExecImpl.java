...
public final class MarketIgnoredExecImpl implements CommonExecRpt, MarketIgnoredExecWrite, Reusable<MarketIgnoredExecImpl> {

   // Attrs

    private transient          MarketIgnoredExecImpl _next = null;
   ...
   // Getters and Setters
    ...
    @Override public ViewString getSecurityId() { throw new IllegalFieldAccess( "Getter for securityId event IgnoredExec is a delegate field from order request base" ); }


    @Override public ViewString getSymbol() { throw new IllegalFieldAccess( "Getter for symbol event IgnoredExec is a delegate field from order request base" ); }


    @Override public Currency getCurrency() { throw new IllegalFieldAccess( "Getter for currency event IgnoredExec is a delegate field from order request base" ); }


    @Override public SecurityIDSource getSecurityIDSource() { throw new IllegalFieldAccess( "Getter for securityIDSource event IgnoredExec is a delegate field from order request base" ); }
    ...
    @Override public double getOrderQty() { throw new IllegalFieldAccess( "Getter for orderQty event IgnoredExec is a delegate field from order request base" ); }


    @Override public double getPrice() { throw new IllegalFieldAccess( "Getter for price event IgnoredExec is a delegate field from order request base" ); }
    ...
    @Override public ViewString getOnBehalfOfId() { throw new IllegalFieldAccess( "Getter for onBehalfOfId event IgnoredExec is a delegate field from order request base" ); }
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.MarketIgnoredExec;
    }

    @Override
    public final MarketIgnoredExecImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( MarketIgnoredExecImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( final ReusableString out ) {
        out.append( "MarketIgnoredExecImpl" ).append( ' ' );
