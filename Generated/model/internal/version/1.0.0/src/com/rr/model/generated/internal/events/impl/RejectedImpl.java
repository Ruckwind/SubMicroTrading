...
public final class RejectedImpl implements CommonExecRpt, RejectedWrite, Copyable<Rejected>, MarketRejectedWrite, Reusable<RejectedImpl> {

   // Attrs

    private transient          RejectedImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.Rejected;
    }

    @Override
    public final RejectedImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( RejectedImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( final ReusableString out ) {
        out.append( "RejectedImpl" ).append( ' ' );
    ...
    @Override public final void snapTo( Rejected dest ) {
        ((RejectedImpl)dest).deepCopyFrom( this );
    }

    /** DEEP copy all members ... INCLUDING subEvents : WARNING CREATES NEW OBJECTS SO MONITOR FOR GC */
    @Override public final void deepCopyFrom( Rejected src ) {
        getOrigClOrdIdForUpdate().copy( src.getOrigClOrdId() );
        setOrdRejReason( src.getOrdRejReason() );
    ...
    @Override public final void shallowCopyFrom( Rejected src ) {
        getOrigClOrdIdForUpdate().copy( src.getOrigClOrdId() );
        setOrdRejReason( src.getOrdRejReason() );
        setTradingStatus( src.getTradingStatus() );
        getExecIdForUpdate().copy( src.getExecId() );
    ...
    /** shallow copy all primitive members ... EXCLUDING subEvents */
    @Override public final void shallowMergeFrom( Rejected src ) {
