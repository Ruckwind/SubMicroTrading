...
public final class DoneForDayImpl implements CommonExecRpt, DoneForDayWrite, Copyable<DoneForDay>, MarketDoneForDayWrite, Reusable<DoneForDayImpl> {

   // Attrs

    private transient          DoneForDayImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.DoneForDay;
    }

    @Override
    public final DoneForDayImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( DoneForDayImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( final ReusableString out ) {
        out.append( "DoneForDayImpl" ).append( ' ' );
    ...
    @Override public final void snapTo( DoneForDay dest ) {
        ((DoneForDayImpl)dest).deepCopyFrom( this );
    }

    /** DEEP copy all members ... INCLUDING subEvents : WARNING CREATES NEW OBJECTS SO MONITOR FOR GC */
    @Override public final void deepCopyFrom( DoneForDay src ) {
    ...
    @Override public final void shallowCopyFrom( DoneForDay src ) {
        getExecIdForUpdate().copy( src.getExecId() );
        getClOrdIdForUpdate().copy( src.getClOrdId() );
        getSecurityIdForUpdate().copy( src.getSecurityId() );
        getSymbolForUpdate().copy( src.getSymbol() );
    ...
    /** shallow copy all primitive members ... EXCLUDING subEvents */
    @Override public final void shallowMergeFrom( DoneForDay src ) {
