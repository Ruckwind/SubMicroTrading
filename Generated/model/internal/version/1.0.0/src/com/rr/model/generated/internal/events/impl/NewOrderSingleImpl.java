...
public final class NewOrderSingleImpl implements OrderRequest, NewOrderSingleWrite, Copyable<NewOrderSingle>, ClientNewOrderSingleWrite, Reusable<NewOrderSingleImpl> {

   // Attrs

    private transient          NewOrderSingleImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.NewOrderSingle;
    }

    @Override
    public final NewOrderSingleImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( NewOrderSingleImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( final ReusableString out ) {
        out.append( "NewOrderSingleImpl" ).append( ' ' );
    ...
    @Override public final void snapTo( NewOrderSingle dest ) {
        ((NewOrderSingleImpl)dest).deepCopyFrom( this );
    }

    /** DEEP copy all members ... INCLUDING subEvents : WARNING CREATES NEW OBJECTS SO MONITOR FOR GC */
    @Override public final void deepCopyFrom( NewOrderSingle src ) {
    ...
    @Override public final void shallowCopyFrom( NewOrderSingle src ) {
        getClOrdIdForUpdate().copy( src.getClOrdId() );
        getAccountForUpdate().copy( src.getAccount() );
        getTextForUpdate().copy( src.getText() );
        setPrice( src.getPrice() );
    ...
    /** shallow copy all primitive members ... EXCLUDING subEvents */
    @Override public final void shallowMergeFrom( NewOrderSingle src ) {
