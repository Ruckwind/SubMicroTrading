...
public final class BookClearImpl implements BaseITCH, BookClearWrite, Copyable<BookClear>, Reusable<BookClearImpl> {

   // Attrs

    private transient          BookClearImpl _next = null;
   ...
   // Helper methods
    ...
    @Override public final void snapTo( BookClear dest ) {
        ((BookClearImpl)dest).deepCopyFrom( this );
    }

    /** DEEP copy all members ... INCLUDING subEvents : WARNING CREATES NEW OBJECTS SO MONITOR FOR GC */
    @Override public final void deepCopyFrom( BookClear src ) {
    ...
    @Override public final void shallowCopyFrom( BookClear src ) {
        setNanosecond( src.getNanosecond() );
        setOrderId( src.getOrderId() );
        setBook( src.getBook() );
        setMsgSeqNum( src.getMsgSeqNum() );
    ...
    /** shallow copy all primitive members ... EXCLUDING subEvents */
    @Override public final void shallowMergeFrom( BookClear src ) {
