...
public final class PendingReplaceImpl implements CommonExecRpt, PendingReplaceWrite, Copyable<PendingReplace>, MarketPendingReplaceWrite, Reusable<PendingReplaceImpl> {

   // Attrs

    private transient          PendingReplaceImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.PendingReplace;
    }

    @Override
    public final PendingReplaceImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( PendingReplaceImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( final ReusableString out ) {
        out.append( "PendingReplaceImpl" ).append( ' ' );
    ...
    @Override public final void snapTo( PendingReplace dest ) {
        ((PendingReplaceImpl)dest).deepCopyFrom( this );
    }

    /** DEEP copy all members ... INCLUDING subEvents : WARNING CREATES NEW OBJECTS SO MONITOR FOR GC */
    @Override public final void deepCopyFrom( PendingReplace src ) {
    ...
    @Override public final void shallowCopyFrom( PendingReplace src ) {
        getOrigClOrdIdForUpdate().copy( src.getOrigClOrdId() );
        getExecIdForUpdate().copy( src.getExecId() );
        getClOrdIdForUpdate().copy( src.getClOrdId() );
        getSecurityIdForUpdate().copy( src.getSecurityId() );
    ...
    /** shallow copy all primitive members ... EXCLUDING subEvents */
    @Override public final void shallowMergeFrom( PendingReplace src ) {
