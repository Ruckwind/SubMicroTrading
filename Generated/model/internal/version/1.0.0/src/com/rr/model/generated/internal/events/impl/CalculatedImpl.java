...
public final class CalculatedImpl implements CommonExecRpt, CalculatedWrite, Copyable<Calculated>, MarketCalculatedWrite, Reusable<CalculatedImpl> {

   // Attrs

    private transient          CalculatedImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.Calculated;
    }

    @Override
    public final CalculatedImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( CalculatedImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( final ReusableString out ) {
        out.append( "CalculatedImpl" ).append( ' ' );
    ...
    @Override public final void snapTo( Calculated dest ) {
        ((CalculatedImpl)dest).deepCopyFrom( this );
    }

    /** DEEP copy all members ... INCLUDING subEvents : WARNING CREATES NEW OBJECTS SO MONITOR FOR GC */
    @Override public final void deepCopyFrom( Calculated src ) {
    ...
    @Override public final void shallowCopyFrom( Calculated src ) {
        getExecIdForUpdate().copy( src.getExecId() );
        getClOrdIdForUpdate().copy( src.getClOrdId() );
        getSecurityIdForUpdate().copy( src.getSecurityId() );
        getSymbolForUpdate().copy( src.getSymbol() );
    ...
    /** shallow copy all primitive members ... EXCLUDING subEvents */
    @Override public final void shallowMergeFrom( Calculated src ) {
