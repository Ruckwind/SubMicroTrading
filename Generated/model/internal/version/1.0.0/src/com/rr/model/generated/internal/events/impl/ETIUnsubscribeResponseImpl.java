...
public final class ETIUnsubscribeResponseImpl implements BaseETIResponse, ETIUnsubscribeResponseWrite, Copyable<ETIUnsubscribeResponse>, Reusable<ETIUnsubscribeResponseImpl> {

   // Attrs

    private transient          ETIUnsubscribeResponseImpl _next = null;
   ...
   // Helper methods
    ...
    @Override public final void snapTo( ETIUnsubscribeResponse dest ) {
        ((ETIUnsubscribeResponseImpl)dest).deepCopyFrom( this );
    }

    /** DEEP copy all members ... INCLUDING subEvents : WARNING CREATES NEW OBJECTS SO MONITOR FOR GC */
    @Override public final void deepCopyFrom( ETIUnsubscribeResponse src ) {
    ...
    @Override public final void shallowCopyFrom( ETIUnsubscribeResponse src ) {
        setRequestTime( src.getRequestTime() );
        setMsgSeqNum( src.getMsgSeqNum() );
        setPossDupFlag( src.getPossDupFlag() );
        setEventTimestamp( src.getEventTimestamp() );
    ...
    /** shallow copy all primitive members ... EXCLUDING subEvents */
    @Override public final void shallowMergeFrom( ETIUnsubscribeResponse src ) {
