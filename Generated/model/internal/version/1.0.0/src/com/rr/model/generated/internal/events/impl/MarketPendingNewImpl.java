...
public final class MarketPendingNewImpl implements CommonExecRpt, MarketPendingNewWrite, Reusable<MarketPendingNewImpl> {

   // Attrs

    private transient          MarketPendingNewImpl _next = null;
   ...
   // Getters and Setters
    ...
    @Override public ViewString getSecurityId() { throw new IllegalFieldAccess( "Getter for securityId event PendingNew is a delegate field from order request base" ); }


    @Override public ViewString getSymbol() { throw new IllegalFieldAccess( "Getter for symbol event PendingNew is a delegate field from order request base" ); }


    @Override public Currency getCurrency() { throw new IllegalFieldAccess( "Getter for currency event PendingNew is a delegate field from order request base" ); }


    @Override public SecurityIDSource getSecurityIDSource() { throw new IllegalFieldAccess( "Getter for securityIDSource event PendingNew is a delegate field from order request base" ); }
    ...
    @Override public double getOrderQty() { throw new IllegalFieldAccess( "Getter for orderQty event PendingNew is a delegate field from order request base" ); }


    @Override public double getPrice() { throw new IllegalFieldAccess( "Getter for price event PendingNew is a delegate field from order request base" ); }
    ...
    @Override public ViewString getOnBehalfOfId() { throw new IllegalFieldAccess( "Getter for onBehalfOfId event PendingNew is a delegate field from order request base" ); }
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.MarketPendingNew;
    }

    @Override
    public final MarketPendingNewImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( MarketPendingNewImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( final ReusableString out ) {
        out.append( "MarketPendingNewImpl" ).append( ' ' );
