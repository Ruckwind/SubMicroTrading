...
public final class ReplacedImpl implements CommonExecRpt, ReplacedWrite, Copyable<Replaced>, MarketReplacedWrite, Reusable<ReplacedImpl> {

   // Attrs

    private transient          ReplacedImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.Replaced;
    }

    @Override
    public final ReplacedImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( ReplacedImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( final ReusableString out ) {
        out.append( "ReplacedImpl" ).append( ' ' );
    ...
    @Override public final void snapTo( Replaced dest ) {
        ((ReplacedImpl)dest).deepCopyFrom( this );
    }

    /** DEEP copy all members ... INCLUDING subEvents : WARNING CREATES NEW OBJECTS SO MONITOR FOR GC */
    @Override public final void deepCopyFrom( Replaced src ) {
    ...
    @Override public final void shallowCopyFrom( Replaced src ) {
        getOrigClOrdIdForUpdate().copy( src.getOrigClOrdId() );
        getExecIdForUpdate().copy( src.getExecId() );
        getClOrdIdForUpdate().copy( src.getClOrdId() );
        getSecurityIdForUpdate().copy( src.getSecurityId() );
    ...
    /** shallow copy all primitive members ... EXCLUDING subEvents */
    @Override public final void shallowMergeFrom( Replaced src ) {
