...
public final class PendingCancelImpl implements CommonExecRpt, PendingCancelWrite, Copyable<PendingCancel>, MarketPendingCancelWrite, Reusable<PendingCancelImpl> {

   // Attrs

    private transient          PendingCancelImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.PendingCancel;
    }

    @Override
    public final PendingCancelImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( PendingCancelImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( final ReusableString out ) {
        out.append( "PendingCancelImpl" ).append( ' ' );
    ...
    @Override public final void snapTo( PendingCancel dest ) {
        ((PendingCancelImpl)dest).deepCopyFrom( this );
    }

    /** DEEP copy all members ... INCLUDING subEvents : WARNING CREATES NEW OBJECTS SO MONITOR FOR GC */
    @Override public final void deepCopyFrom( PendingCancel src ) {
    ...
    @Override public final void shallowCopyFrom( PendingCancel src ) {
        getOrigClOrdIdForUpdate().copy( src.getOrigClOrdId() );
        getExecIdForUpdate().copy( src.getExecId() );
        getClOrdIdForUpdate().copy( src.getClOrdId() );
        getSecurityIdForUpdate().copy( src.getSecurityId() );
    ...
    /** shallow copy all primitive members ... EXCLUDING subEvents */
    @Override public final void shallowMergeFrom( PendingCancel src ) {
