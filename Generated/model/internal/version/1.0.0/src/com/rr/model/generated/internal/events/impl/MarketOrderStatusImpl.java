...
public final class MarketOrderStatusImpl implements CommonExecRpt, MarketOrderStatusWrite, Reusable<MarketOrderStatusImpl> {
   ...
   // Attrs
    ...
    private transient          MarketOrderStatusImpl _next = null;
   ...
   // Getters and Setters
    ...
    @Override public double getOrderQty() { throw new IllegalFieldAccess( "Getter for orderQty event OrderStatus is a delegate field from order request base" ); }
