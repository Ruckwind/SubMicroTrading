...
public final class ForceCancelImpl implements CommonHeader, ForceCancelWrite, Copyable<ForceCancel>, ClientForceCancelWrite, Reusable<ForceCancelImpl> {

   // Attrs

    private transient          ForceCancelImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.ForceCancel;
    }

    @Override
    public final ForceCancelImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( ForceCancelImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( final ReusableString out ) {
        out.append( "ForceCancelImpl" ).append( ' ' );
    ...
    @Override public final void snapTo( ForceCancel dest ) {
        ((ForceCancelImpl)dest).deepCopyFrom( this );
    }

    /** DEEP copy all members ... INCLUDING subEvents : WARNING CREATES NEW OBJECTS SO MONITOR FOR GC */
    @Override public final void deepCopyFrom( ForceCancel src ) {
    ...
    @Override public final void shallowCopyFrom( ForceCancel src ) {
        getClOrdIdForUpdate().copy( src.getClOrdId() );
        getOrigClOrdIdForUpdate().copy( src.getOrigClOrdId() );
        getOrderIdForUpdate().copy( src.getOrderId() );
        setSide( src.getSide() );
    ...
    /** shallow copy all primitive members ... EXCLUDING subEvents */
    @Override public final void shallowMergeFrom( ForceCancel src ) {
