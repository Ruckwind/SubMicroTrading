...
public final class IgnoredExecImpl implements CommonExecRpt, IgnoredExecWrite, Copyable<IgnoredExec>, MarketIgnoredExecWrite, Reusable<IgnoredExecImpl> {

   // Attrs

    private transient          IgnoredExecImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.IgnoredExec;
    }

    @Override
    public final IgnoredExecImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( IgnoredExecImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( final ReusableString out ) {
        out.append( "IgnoredExecImpl" ).append( ' ' );
    ...
    @Override public final void snapTo( IgnoredExec dest ) {
        ((IgnoredExecImpl)dest).deepCopyFrom( this );
    }

    /** DEEP copy all members ... INCLUDING subEvents : WARNING CREATES NEW OBJECTS SO MONITOR FOR GC */
    @Override public final void deepCopyFrom( IgnoredExec src ) {
    ...
    @Override public final void shallowCopyFrom( IgnoredExec src ) {
        getExecIdForUpdate().copy( src.getExecId() );
        getClOrdIdForUpdate().copy( src.getClOrdId() );
        getSecurityIdForUpdate().copy( src.getSecurityId() );
        getSymbolForUpdate().copy( src.getSymbol() );
    ...
    /** shallow copy all primitive members ... EXCLUDING subEvents */
    @Override public final void shallowMergeFrom( IgnoredExec src ) {
