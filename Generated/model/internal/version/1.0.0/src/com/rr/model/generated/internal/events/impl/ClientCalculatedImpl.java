...
public final class ClientCalculatedImpl implements CommonExecRpt, ClientCalculatedUpdate, Reusable<ClientCalculatedImpl> {

   // Attrs

    private transient          ClientCalculatedImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.ClientCalculated;
    }

    @Override
    public final ClientCalculatedImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( ClientCalculatedImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( final ReusableString out ) {
        out.append( "ClientCalculatedImpl" ).append( ' ' );
