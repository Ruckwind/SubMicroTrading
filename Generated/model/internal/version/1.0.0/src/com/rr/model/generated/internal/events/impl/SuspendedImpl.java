...
public final class SuspendedImpl implements CommonExecRpt, SuspendedWrite, Copyable<Suspended>, MarketSuspendedWrite, Reusable<SuspendedImpl> {

   // Attrs

    private transient          SuspendedImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.Suspended;
    }

    @Override
    public final SuspendedImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( SuspendedImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( final ReusableString out ) {
        out.append( "SuspendedImpl" ).append( ' ' );
    ...
    @Override public final void snapTo( Suspended dest ) {
        ((SuspendedImpl)dest).deepCopyFrom( this );
    }

    /** DEEP copy all members ... INCLUDING subEvents : WARNING CREATES NEW OBJECTS SO MONITOR FOR GC */
    @Override public final void deepCopyFrom( Suspended src ) {
    ...
    @Override public final void shallowCopyFrom( Suspended src ) {
        getExecIdForUpdate().copy( src.getExecId() );
        getClOrdIdForUpdate().copy( src.getClOrdId() );
        getSecurityIdForUpdate().copy( src.getSecurityId() );
        getSymbolForUpdate().copy( src.getSymbol() );
    ...
    /** shallow copy all primitive members ... EXCLUDING subEvents */
    @Override public final void shallowMergeFrom( Suspended src ) {
