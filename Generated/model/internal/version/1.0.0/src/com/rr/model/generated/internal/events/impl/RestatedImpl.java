...
public final class RestatedImpl implements CommonExecRpt, RestatedWrite, Copyable<Restated>, MarketRestatedWrite, Reusable<RestatedImpl> {

   // Attrs

    private transient          RestatedImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.Restated;
    }

    @Override
    public final RestatedImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( RestatedImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( final ReusableString out ) {
        out.append( "RestatedImpl" ).append( ' ' );
        if ( getExecRestatementReason() != null )             out.append( ", execRestatementReason=" ).append( getExecRestatementReason() );
    ...
    @Override public final void snapTo( Restated dest ) {
        ((RestatedImpl)dest).deepCopyFrom( this );
    }

    /** DEEP copy all members ... INCLUDING subEvents : WARNING CREATES NEW OBJECTS SO MONITOR FOR GC */
    @Override public final void deepCopyFrom( Restated src ) {
        setExecRestatementReason( src.getExecRestatementReason() );
    ...
    @Override public final void shallowCopyFrom( Restated src ) {
        setExecRestatementReason( src.getExecRestatementReason() );
        getExecIdForUpdate().copy( src.getExecId() );
        getClOrdIdForUpdate().copy( src.getClOrdId() );
        getSecurityIdForUpdate().copy( src.getSecurityId() );
    ...
    /** shallow copy all primitive members ... EXCLUDING subEvents */
    @Override public final void shallowMergeFrom( Restated src ) {
        setExecRestatementReason( src.getExecRestatementReason() );
