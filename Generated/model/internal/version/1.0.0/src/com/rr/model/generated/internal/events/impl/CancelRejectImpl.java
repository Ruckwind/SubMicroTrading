...
public final class CancelRejectImpl implements CommonExchangeHeader, CancelRejectWrite, Copyable<CancelReject>, MarketCancelRejectWrite, Reusable<CancelRejectImpl> {

   // Attrs

    private transient          CancelRejectImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.CancelReject;
    }

    @Override
    public final CancelRejectImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( CancelRejectImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( final ReusableString out ) {
        out.append( "CancelRejectImpl" ).append( ' ' );
        ...
        if ( getCxlRejReason() != null )             out.append( ", cxlRejReason=" ).append( getCxlRejReason() );
        if ( getCxlRejResponseTo() != null )             out.append( ", cxlRejResponseTo=" ).append( getCxlRejResponseTo() );
    ...
    @Override public final void snapTo( CancelReject dest ) {
        ((CancelRejectImpl)dest).deepCopyFrom( this );
    }

    /** DEEP copy all members ... INCLUDING subEvents : WARNING CREATES NEW OBJECTS SO MONITOR FOR GC */
    @Override public final void deepCopyFrom( CancelReject src ) {
        ...
        setCxlRejReason( src.getCxlRejReason() );
        setCxlRejResponseTo( src.getCxlRejResponseTo() );
    ...
    @Override public final void shallowCopyFrom( CancelReject src ) {
        getOrderIdForUpdate().copy( src.getOrderId() );
        getClOrdIdForUpdate().copy( src.getClOrdId() );
        getOrigClOrdIdForUpdate().copy( src.getOrigClOrdId() );
        setCxlRejReason( src.getCxlRejReason() );
    ...
    /** shallow copy all primitive members ... EXCLUDING subEvents */
    @Override public final void shallowMergeFrom( CancelReject src ) {
