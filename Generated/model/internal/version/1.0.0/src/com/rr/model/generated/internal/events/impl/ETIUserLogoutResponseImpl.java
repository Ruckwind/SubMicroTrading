...
public final class ETIUserLogoutResponseImpl implements BaseETIResponse, ETIUserLogoutResponseWrite, Copyable<ETIUserLogoutResponse>, Reusable<ETIUserLogoutResponseImpl> {

   // Attrs

    private transient          ETIUserLogoutResponseImpl _next = null;
   ...
   // Helper methods
    ...
    @Override public final void snapTo( ETIUserLogoutResponse dest ) {
        ((ETIUserLogoutResponseImpl)dest).deepCopyFrom( this );
    }

    /** DEEP copy all members ... INCLUDING subEvents : WARNING CREATES NEW OBJECTS SO MONITOR FOR GC */
    @Override public final void deepCopyFrom( ETIUserLogoutResponse src ) {
    ...
    @Override public final void shallowCopyFrom( ETIUserLogoutResponse src ) {
        setRequestTime( src.getRequestTime() );
        setMsgSeqNum( src.getMsgSeqNum() );
        setPossDupFlag( src.getPossDupFlag() );
        setEventTimestamp( src.getEventTimestamp() );
    ...
    /** shallow copy all primitive members ... EXCLUDING subEvents */
    @Override public final void shallowMergeFrom( ETIUserLogoutResponse src ) {
