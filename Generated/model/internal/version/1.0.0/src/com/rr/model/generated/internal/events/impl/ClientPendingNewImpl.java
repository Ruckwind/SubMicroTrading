...
public final class ClientPendingNewImpl implements CommonExecRpt, ClientPendingNewUpdate, Reusable<ClientPendingNewImpl> {

   // Attrs

    private transient          ClientPendingNewImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.ClientPendingNew;
    }

    @Override
    public final ClientPendingNewImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( ClientPendingNewImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( final ReusableString out ) {
        out.append( "ClientPendingNewImpl" ).append( ' ' );
