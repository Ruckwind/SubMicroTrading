...
public final class MarketRestatedImpl implements CommonExecRpt, MarketRestatedWrite, Reusable<MarketRestatedImpl> {
   ...
   // Attrs
    ...
    private transient          MarketRestatedImpl _next = null;
   ...
   // Getters and Setters
    ...
    @Override public double getOrderQty() { throw new IllegalFieldAccess( "Getter for orderQty event Restated is a delegate field from order request base" ); }
