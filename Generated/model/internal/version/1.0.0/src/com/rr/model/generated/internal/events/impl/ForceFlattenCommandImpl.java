...
public final class ForceFlattenCommandImpl implements CommonHeader, ForceFlattenCommandWrite, Copyable<ForceFlattenCommand>, Reusable<ForceFlattenCommandImpl> {

   // Attrs

    private transient          ForceFlattenCommandImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.ForceFlattenCommand;
    }

    @Override
    public final ForceFlattenCommandImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( ForceFlattenCommandImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( final ReusableString out ) {
        out.append( "ForceFlattenCommandImpl" ).append( ' ' );
    ...
    @Override public final void snapTo( ForceFlattenCommand dest ) {
        ((ForceFlattenCommandImpl)dest).deepCopyFrom( this );
    }

    /** DEEP copy all members ... INCLUDING subEvents : WARNING CREATES NEW OBJECTS SO MONITOR FOR GC */
    @Override public final void deepCopyFrom( ForceFlattenCommand src ) {
    ...
    @Override public final void shallowCopyFrom( ForceFlattenCommand src ) {
        getStratIdForUpdate().copy( src.getStratId() );
        setMsgSeqNum( src.getMsgSeqNum() );
        setPossDupFlag( src.getPossDupFlag() );
        setEventTimestamp( src.getEventTimestamp() );
    ...
    /** shallow copy all primitive members ... EXCLUDING subEvents */
    @Override public final void shallowMergeFrom( ForceFlattenCommand src ) {
