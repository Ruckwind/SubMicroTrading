...
public final class MarketPendingCancelImpl implements CommonExecRpt, MarketPendingCancelWrite, Reusable<MarketPendingCancelImpl> {

   // Attrs

    private transient          MarketPendingCancelImpl _next = null;
   ...
   // Getters and Setters
    ...
    @Override public ViewString getSecurityId() { throw new IllegalFieldAccess( "Getter for securityId event PendingCancel is a delegate field from order request base" ); }


    @Override public ViewString getSymbol() { throw new IllegalFieldAccess( "Getter for symbol event PendingCancel is a delegate field from order request base" ); }


    @Override public Currency getCurrency() { throw new IllegalFieldAccess( "Getter for currency event PendingCancel is a delegate field from order request base" ); }


    @Override public SecurityIDSource getSecurityIDSource() { throw new IllegalFieldAccess( "Getter for securityIDSource event PendingCancel is a delegate field from order request base" ); }
    ...
    @Override public double getOrderQty() { throw new IllegalFieldAccess( "Getter for orderQty event PendingCancel is a delegate field from order request base" ); }


    @Override public double getPrice() { throw new IllegalFieldAccess( "Getter for price event PendingCancel is a delegate field from order request base" ); }
    ...
    @Override public ViewString getOnBehalfOfId() { throw new IllegalFieldAccess( "Getter for onBehalfOfId event PendingCancel is a delegate field from order request base" ); }
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.MarketPendingCancel;
    }

    @Override
    public final MarketPendingCancelImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( MarketPendingCancelImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( final ReusableString out ) {
        out.append( "MarketPendingCancelImpl" ).append( ' ' );
