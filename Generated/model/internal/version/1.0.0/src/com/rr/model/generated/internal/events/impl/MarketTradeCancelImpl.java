...
public final class MarketTradeCancelImpl implements TradeBase, MarketTradeCancelWrite, Reusable<MarketTradeCancelImpl> {
   ...
   // Attrs
    ...
    private transient          MarketTradeCancelImpl _next = null;
   ...
   // Getters and Setters
    ...
    @Override public double getOrderQty() { throw new IllegalFieldAccess( "Getter for orderQty event TradeCancel is a delegate field from order request base" ); }
