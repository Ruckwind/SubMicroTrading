...
public final class MarketRejectedImpl implements CommonExecRpt, MarketRejectedWrite, Reusable<MarketRejectedImpl> {
   ...
   // Attrs
    ...
    private transient          MarketRejectedImpl _next = null;
   ...
   // Getters and Setters
    ...
    @Override public double getOrderQty() { throw new IllegalFieldAccess( "Getter for orderQty event Rejected is a delegate field from order request base" ); }
