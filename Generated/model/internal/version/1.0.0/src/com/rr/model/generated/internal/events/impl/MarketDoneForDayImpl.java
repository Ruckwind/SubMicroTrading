...
public final class MarketDoneForDayImpl implements CommonExecRpt, MarketDoneForDayWrite, Reusable<MarketDoneForDayImpl> {
   ...
   // Attrs
    ...
    private transient          MarketDoneForDayImpl _next = null;
   ...
   // Getters and Setters
    ...
    @Override public double getOrderQty() { throw new IllegalFieldAccess( "Getter for orderQty event DoneForDay is a delegate field from order request base" ); }
