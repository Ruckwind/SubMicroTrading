...
public final class MarketReplacedImpl implements CommonExecRpt, MarketReplacedWrite, Reusable<MarketReplacedImpl> {
   ...
   // Attrs
    ...
    private transient          MarketReplacedImpl _next = null;
   ...
   // Getters and Setters
    ...
    @Override public double getOrderQty() { throw new IllegalFieldAccess( "Getter for orderQty event Replaced is a delegate field from order request base" ); }
