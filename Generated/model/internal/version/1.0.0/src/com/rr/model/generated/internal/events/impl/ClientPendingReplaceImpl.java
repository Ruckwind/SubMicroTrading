...
public final class ClientPendingReplaceImpl implements CommonExecRpt, ClientPendingReplaceUpdate, Reusable<ClientPendingReplaceImpl> {

   // Attrs

    private transient          ClientPendingReplaceImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.ClientPendingReplace;
    }

    @Override
    public final ClientPendingReplaceImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( ClientPendingReplaceImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( final ReusableString out ) {
        out.append( "ClientPendingReplaceImpl" ).append( ' ' );
