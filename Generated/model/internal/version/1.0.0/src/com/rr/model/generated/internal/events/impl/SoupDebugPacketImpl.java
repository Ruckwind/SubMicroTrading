...
public final class SoupDebugPacketImpl implements BaseSoup, SoupDebugPacketWrite, Copyable<SoupDebugPacket>, Reusable<SoupDebugPacketImpl> {

   // Attrs

    private transient          SoupDebugPacketImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.SoupDebugPacket;
    }

    @Override
    public final SoupDebugPacketImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( SoupDebugPacketImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( final ReusableString out ) {
        out.append( "SoupDebugPacketImpl" ).append( ' ' );
    ...
    @Override public final void snapTo( SoupDebugPacket dest ) {
        ((SoupDebugPacketImpl)dest).deepCopyFrom( this );
    }

    /** DEEP copy all members ... INCLUDING subEvents : WARNING CREATES NEW OBJECTS SO MONITOR FOR GC */
    @Override public final void deepCopyFrom( SoupDebugPacket src ) {
    ...
    @Override public final void shallowCopyFrom( SoupDebugPacket src ) {
        getTextForUpdate().copy( src.getText() );
        setMsgSeqNum( src.getMsgSeqNum() );
        setPossDupFlag( src.getPossDupFlag() );
        setEventTimestamp( src.getEventTimestamp() );
    ...
    /** shallow copy all primitive members ... EXCLUDING subEvents */
    @Override public final void shallowMergeFrom( SoupDebugPacket src ) {
