...
public final class StoppedImpl implements CommonExecRpt, StoppedWrite, Copyable<Stopped>, MarketStoppedWrite, Reusable<StoppedImpl> {

   // Attrs

    private transient          StoppedImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.Stopped;
    }

    @Override
    public final StoppedImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( StoppedImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    @Override public final void snapTo( Stopped dest ) {
        ((StoppedImpl)dest).deepCopyFrom( this );
    }

    /** DEEP copy all members ... INCLUDING subEvents : WARNING CREATES NEW OBJECTS SO MONITOR FOR GC */
    @Override public final void deepCopyFrom( Stopped src ) {
    ...
    @Override public final void shallowCopyFrom( Stopped src ) {
        setLastQty( src.getLastQty() );
        setLastPx( src.getLastPx() );
        getExecIdForUpdate().copy( src.getExecId() );
        getClOrdIdForUpdate().copy( src.getClOrdId() );
    ...
    /** shallow copy all primitive members ... EXCLUDING subEvents */
    @Override public final void shallowMergeFrom( Stopped src ) {
