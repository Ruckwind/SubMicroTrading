...
public final class ClosingPriceEventImpl implements CommonHeader, ClosingPriceEventWrite, Copyable<ClosingPriceEvent>, Reusable<ClosingPriceEventImpl> {

   // Attrs

    private transient          ClosingPriceEventImpl _next = null;
    ...
    @TimestampMS private long _closeDateTime = Constants.UNSET_LONG;
    private int _msgSeqNum = Constants.UNSET_INT;
    @TimestampMS private long _eventTimestamp = Constants.UNSET_LONG;

    private DataSrc _dataSrc = DataSrc.UNS;
    private Instrument _instrument;
    private ClosingPriceType _closingPriceType = ClosingPriceType.Unknown;
   ...
   // Getters and Setters
    ...
    @Override public final ClosingPriceType getClosingPriceType() { return _closingPriceType; }
    @Override public final void setClosingPriceType( ClosingPriceType val ) { _closingPriceType = val; }

    @Override public final long getCloseDateTime() { return _closeDateTime; }
    @Override public final void setCloseDateTime( long val ) { _closeDateTime = val; }
   ...
   // Reusable Contract
    ...
    public final void reset() {
        ...
        _closingPriceType = ClosingPriceType.Unknown;
        _closeDateTime = Constants.UNSET_LONG;
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.ClosingPriceEvent;
    }

    @Override
    public final ClosingPriceEventImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( ClosingPriceEventImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( final ReusableString out ) {
        out.append( "ClosingPriceEventImpl" ).append( ' ' );
        ...
        if ( getClosingPriceType() != null )             out.append( ", closingPriceType=" ).append( getClosingPriceType() );
        if ( Constants.UNSET_LONG != getCloseDateTime() && 0 != getCloseDateTime() ) {
            out.append( ", closeDateTime=" );
            TimeUtilsFactory.safeTimeUtils().unixTimeToLocalTimestamp( out, getCloseDateTime() );
            out.append( " / " );
            TimeUtilsFactory.safeTimeUtils().unixTimeToUTCTimestamp( out, getCloseDateTime() );
            out.append( " ( " );
            out.append( getCloseDateTime() ).append( " ) " );
        }
    ...
    @Override public final void snapTo( ClosingPriceEvent dest ) {
        ((ClosingPriceEventImpl)dest).deepCopyFrom( this );
    }

    /** DEEP copy all members ... INCLUDING subEvents : WARNING CREATES NEW OBJECTS SO MONITOR FOR GC */
    @Override public final void deepCopyFrom( ClosingPriceEvent src ) {
        ...
        setClosingPriceType( src.getClosingPriceType() );
        setCloseDateTime( src.getCloseDateTime() );
    ...
    @Override public final void shallowCopyFrom( ClosingPriceEvent src ) {
        setDataSrc( src.getDataSrc() );
        setInstrument( src.getInstrument() );
        getSubjectForUpdate().copy( src.getSubject() );
        setDataSeqNum( src.getDataSeqNum() );
    ...
    /** shallow copy all primitive members ... EXCLUDING subEvents */
    @Override public final void shallowMergeFrom( ClosingPriceEvent src ) {
        ...
        setClosingPriceType( src.getClosingPriceType() );
        if ( Constants.UNSET_LONG != src.getCloseDateTime() ) setCloseDateTime( src.getCloseDateTime() );
