...
public final class TradeCancelImpl implements TradeBase, TradeCancelWrite, Copyable<TradeCancel>, MarketTradeCancelWrite, Reusable<TradeCancelImpl> {

   // Attrs

    private transient          TradeCancelImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.TradeCancel;
    }

    @Override
    public final TradeCancelImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( TradeCancelImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( final ReusableString out ) {
        out.append( "TradeCancelImpl" ).append( ' ' );
    ...
    @Override public final void snapTo( TradeCancel dest ) {
        ((TradeCancelImpl)dest).deepCopyFrom( this );
    }

    /** DEEP copy all members ... INCLUDING subEvents : WARNING CREATES NEW OBJECTS SO MONITOR FOR GC */
    @Override public final void deepCopyFrom( TradeCancel src ) {
    ...
    @Override public final void shallowCopyFrom( TradeCancel src ) {
        getExecRefIDForUpdate().copy( src.getExecRefID() );
        setLastQty( src.getLastQty() );
        setLastPx( src.getLastPx() );
        setLiquidityInd( src.getLiquidityInd() );
    ...
    /** shallow copy all primitive members ... EXCLUDING subEvents */
    @Override public final void shallowMergeFrom( TradeCancel src ) {
