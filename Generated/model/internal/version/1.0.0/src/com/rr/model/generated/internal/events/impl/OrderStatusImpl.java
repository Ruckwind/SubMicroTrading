...
public final class OrderStatusImpl implements CommonExecRpt, OrderStatusWrite, Copyable<OrderStatus>, MarketOrderStatusWrite, Reusable<OrderStatusImpl> {

   // Attrs

    private transient          OrderStatusImpl _next = null;
   ...
   // Reusable Contract
    ...
    public final ReusableType getReusableType() {
        return ModelReusableTypes.OrderStatus;
    }

    @Override
    public final OrderStatusImpl getNext() {
        return _next;
    }

    @Override
    public final void setNext( OrderStatusImpl nxt ) {
        _next = nxt;
    }
   ...
   // Helper methods
    ...
    public final void dump( final ReusableString out ) {
        out.append( "OrderStatusImpl" ).append( ' ' );
    ...
    @Override public final void snapTo( OrderStatus dest ) {
        ((OrderStatusImpl)dest).deepCopyFrom( this );
    }

    /** DEEP copy all members ... INCLUDING subEvents : WARNING CREATES NEW OBJECTS SO MONITOR FOR GC */
    @Override public final void deepCopyFrom( OrderStatus src ) {
    ...
    @Override public final void shallowCopyFrom( OrderStatus src ) {
        getExecIdForUpdate().copy( src.getExecId() );
        getClOrdIdForUpdate().copy( src.getClOrdId() );
        getSecurityIdForUpdate().copy( src.getSecurityId() );
        getSymbolForUpdate().copy( src.getSymbol() );
    ...
    /** shallow copy all primitive members ... EXCLUDING subEvents */
    @Override public final void shallowMergeFrom( OrderStatus src ) {
