 ...
 */
public final class TCPPitchDecodeBuilderImpl implements BinaryDecodeBuilder {
    ...
    public TCPPitchDecodeBuilderImpl() {
        super();
        _tzCalc.setLocalTimezone( TimeZone.getTimeZone( "Europe/London" ) );
    }
    ...
    @Override public long decodeTimestampLocal()              { return decodeLong( 11 ); }
