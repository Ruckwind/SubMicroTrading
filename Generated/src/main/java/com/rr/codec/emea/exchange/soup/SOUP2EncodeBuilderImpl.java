 ...
 */
public final class SOUP2EncodeBuilderImpl extends BinaryLittleEndianEncoderUtils {
    ...
    public SOUP2EncodeBuilderImpl( byte[] buffer, int offset, ZString protocolVersion ) {
        super( buffer, offset );
