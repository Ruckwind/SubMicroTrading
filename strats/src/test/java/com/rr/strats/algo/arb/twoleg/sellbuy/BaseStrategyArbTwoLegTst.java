...
import com.rr.strats.algo.arb.twoleg.sellbuy.StratExchSpreadSellLeg1BuyLeg2Arb;
import com.rr.strats.algo.twoleg.catchup.CatchUpStates;
import static org.junit.Assert.*;


public abstract class BaseStrategyArbTwoLegTst extends BaseStrategyArbTst<StratExchSpreadSellLeg1BuyLeg2Arb, AlgoExchangeTwoLegSellBuyArb> {
    ...
    @Override
    protected AlgoExchangeTwoLegSellBuyArb createAlgoInstance( String algoId ) {
        return new AlgoExchangeTwoLegSellBuyArb( algoId );
    }

    @Override
    protected Class<? extends Algo<? extends Book>> getAlgoClass() {
        return AlgoExchangeTwoLegSellBuyArb.class;
    }
    ...
    public void createStrategyInstance( OrderRouter router, StrategyDefinition def, int bookLevels ) {
        _strat = new StratExchSpreadSellLeg1BuyLeg2Arb( "A1S1" );
