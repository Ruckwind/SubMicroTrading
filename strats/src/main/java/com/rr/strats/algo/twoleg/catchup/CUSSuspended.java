...
public class CUSSuspended extends BaseMultiLegArbCatchupHandler {

    public CUSSuspended( CatchUpStates catchupStates ) {
        super( "CUSSuspended", catchupStates );
    }

    @Override
    public void checkForAction( BaseStrategyExchTwoLegArb strat ) {
        // DO NOTHING SUSPENDED
    }
}
